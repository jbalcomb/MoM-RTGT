...
std::ostream& operator<<(std::ostream& os, const eRanged_Type& rhs)
{
    ...
    case RANGED_Chaos_Magic3_Demon: os << "RANGED_Chaos_Magic3_Demon"; break;
    case RANGED_Nature_Magic1_Wind_Mage: os << "RANGED_Nature_Magic1_Wind_Mage"; break;
    case RANGED_Nature_Magic2_Shamans: os << "RANGED_Nature_Magic2_Shamans"; break;
    case RANGED_Chaos_Magic4_Dark_Elves: os << "RANGED_Chaos_Magic4_Dark_Elves"; break;
    case RANGED_Nature_Magic3_Sprites: os << "RANGED_Nature_Magic3_Sprites"; break;
    case RANGED_Nature_Magic4_Druid: os << "RANGED_Nature_Magic4_Druid"; break;
...
std::ostream& operator<<(std::ostream& os, const eTerrainBonusDeposit& rhs)
{
    ...
    case DEPOSIT_Unk10: os << "DEPOSIT_Unk10"; break;
    case DEPOSIT_Unk20: os << "DEPOSIT_Unk20"; break;
...
std::ostream& operator<<(std::ostream& os, const eTerrainChange& rhs)
{
    ...
    case TERRAINCHANGE_Unk40: os << "TERRAINCHANGE_Unk40"; break;
...
std::ostream& operator<<(std::ostream& os, const eUnit_Status8& rhs)
{
    ...
    case UNITSTATUS8_unk6: os << "UNITSTATUS8_unk6"; break;
    case UNITSTATUS8_meld_GUESS: os << "UNITSTATUS8_meld_GUESS"; break;
    case UNITSTATUS8_build_GUESS: os << "UNITSTATUS8_build_GUESS"; break;
    case UNITSTATUS8_seek_transport_GUESS: os << "UNITSTATUS8_seek_transport_GUESS"; break;
    case UNITSTATUS8_unk10: os << "UNITSTATUS8_unk10"; break;
    case UNITSTATUS8_unk11: os << "UNITSTATUS8_unk11"; break;
    case UNITSTATUS8_unk12: os << "UNITSTATUS8_unk12"; break;
    case UNITSTATUS8_unk13: os << "UNITSTATUS8_unk13"; break;
    case UNITSTATUS8_unk14: os << "UNITSTATUS8_unk14"; break;
    case UNITSTATUS8_unk15: os << "UNITSTATUS8_unk15"; break;
...
std::ostream& operator<<(std::ostream& os, const Available_spell_page& rhs)
{
    ...
    os << "m_Zero=" << (unsigned)rhs.m_Zero << " 0x" << std::hex << (unsigned)rhs.m_Zero << std::dec << "\n";
    os << "}";
    return os;
}
...
std::ostream& operator<<(std::ostream& os, const Battle_Unit& rhs)
{
    ...
    os << "m_Zero03=" << rhs.m_Zero03 << " 0x" << std::hex << rhs.m_Zero03 << std::dec << "\n";
    ...
    os << "m_UNK4C_display_GUESS=" << rhs.m_UNK4C_display_GUESS << " 0x" << std::hex << rhs.m_UNK4C_display_GUESS << std::dec << "\n";
    ...
    for (unsigned i = 0; i < 6; ++i)
    {
        os << "[" << i << "] " << rhs.m_UNK58[i] << " 0x" << std::hex << rhs.m_UNK58[i] << std::dec << ",\n";
    }
    os << ")\n";
...
std::ostream& operator<<(std::ostream& os, const Battlefield& rhs)
{
    ...
    for (unsigned i = 0; i < 462; ++i)
    {
        os << "[" << i << "] " << (unsigned)rhs.m_Movement_similar_to_walking[i] << " 0x" << std::hex << (unsigned)rhs.m_Movement_similar_to_walking[i] << std::dec << ",\n";
    }
    os << ")\n";
    ...
    {
        os << "[" << i << "] " << (unsigned)rhs.field_14F8[i] << " 0x" << std::hex << (unsigned)rhs.field_14F8[i] << std::dec << ",\n";
    }
    os << ")\n";
    os << "field_1516=" << rhs.field_1516 << " 0x" << std::hex << rhs.field_1516 << std::dec << "\n";
    os << "field_1518=(\n";
    for (unsigned i = 0; i < 30; ++i)
    {
        os << "[" << i << "] " << (unsigned)rhs.field_1518[i] << " 0x" << std::hex << (unsigned)rhs.field_1518[i] << std::dec << ",\n";
    }
    os << ")\n";
    os << "field_1536=" << rhs.field_1536 << " 0x" << std::hex << rhs.field_1536 << std::dec << "\n";
    os << "field_1538=(\n";
    for (unsigned i = 0; i < 30; ++i)
    {
...
std::ostream& operator<<(std::ostream& os, const City& rhs)
{
    ...
    os << "m_Number_of_farmers_allocated=" << (unsigned)rhs.m_Number_of_farmers_allocated << " 0x" << std::hex << (unsigned)rhs.m_Number_of_farmers_allocated << std::dec << "\n";
    os << "m_UNK01a=(\n";
    for (unsigned i = 0; i < 2; ++i)
    {
        os << "[" << i << "] " << (unsigned)rhs.m_UNK01a[i] << " 0x" << std::hex << (unsigned)rhs.m_UNK01a[i] << std::dec << ",\n";
    }
    os << ")\n";
    os << "m_PopulationDekaPop=" << (unsigned)rhs.m_PopulationDekaPop << " 0x" << std::hex << (unsigned)rhs.m_PopulationDekaPop << std::dec << "\n";
    os << "m_UNK01b=" << (unsigned)rhs.m_UNK01b << " 0x" << std::hex << (unsigned)rhs.m_UNK01b << std::dec << "\n";
    ...
    os << "m_UNK01c=" << (unsigned)rhs.m_UNK01c << " 0x" << std::hex << (unsigned)rhs.m_UNK01c << std::dec << "\n";
    os << "m_Producing=" << rhs.m_Producing << "\n";
    os << "m_UNK02=" << (unsigned)rhs.m_UNK02 << " 0x" << std::hex << (unsigned)rhs.m_UNK02 << std::dec << "\n";
    os << "m_Building_Status=" << rhs.m_Building_Status << "\n";
    os << "m_City_Enchantments=" << rhs.m_City_Enchantments << "\n";
    os << "m_Nightshade=" << rhs.m_Nightshade << "\n";
    os << "m_Hammers=" << (unsigned)rhs.m_Hammers << " 0x" << std::hex << (unsigned)rhs.m_Hammers << std::dec << "\n";
    os << "m_HammersAccumulated=" << rhs.m_HammersAccumulated << " 0x" << std::hex << rhs.m_HammersAccumulated << std::dec << "\n";
    os << "m_Coins=" << (unsigned)rhs.m_Coins << " 0x" << std::hex << (unsigned)rhs.m_Coins << std::dec << "\n";
    os << "m_Maintenance=" << (unsigned)rhs.m_Maintenance << " 0x" << std::hex << (unsigned)rhs.m_Maintenance << std::dec << "\n";
    os << "m_Mana_cr=" << (unsigned)rhs.m_Mana_cr << " 0x" << std::hex << (unsigned)rhs.m_Mana_cr << std::dec << "\n";
    os << "m_Research=" << (unsigned)rhs.m_Research << " 0x" << std::hex << (unsigned)rhs.m_Research << std::dec << "\n";
    os << "m_Food_Produced=" << (unsigned)rhs.m_Food_Produced << " 0x" << std::hex << (unsigned)rhs.m_Food_Produced << std::dec << "\n";
...
std::ostream& operator<<(std::ostream& os, const Game_Settings& rhs)
{
    ...
    os << "m_UNK01=" << rhs.m_UNK01 << " 0x" << std::hex << rhs.m_UNK01 << std::dec << "\n";
    os << "m_UNK02=" << rhs.m_UNK02 << " 0x" << std::hex << rhs.m_UNK02 << std::dec << "\n";
    os << "m_Difficulty=" << rhs.m_Difficulty << "\n";
    ...
    {
        os << "[" << i << "] " << rhs.m_UNK03[i] << " 0x" << std::hex << rhs.m_UNK03[i] << std::dec << ",\n";
    }
    os << ")\n";
    os << "}";
    return os;
...
std::ostream& operator<<(std::ostream& os, const HelpLBXentry& rhs)
{
    ...
    os << "zero=" << rhs.zero << " 0x" << std::hex << rhs.zero << std::dec << "\n";
...
std::ostream& operator<<(std::ostream& os, const MapRow_LandMassID& rhs)
{
    ...
    for (unsigned i = 0; i < 60; ++i)
    {
        os << "[" << i << "] " << (unsigned)rhs.m_LandMassID[i] << " 0x" << std::hex << (unsigned)rhs.m_LandMassID[i] << std::dec << ",\n";
    }
    os << ")\n";
    os << "}";
    return os;
...
std::ostream& operator<<(std::ostream& os, const MoMDataSegment& rhs)
{
    ...
    {
        os << "[" << i << "] " << (unsigned)rhs.m_UNK06c[i] << " 0x" << std::hex << (unsigned)rhs.m_UNK06c[i] << std::dec << ",\n";
    }
    os << ")\n";
    ...
    {
        os << "[" << i << "] " << (unsigned)rhs.m_UNK07[i] << " 0x" << std::hex << (unsigned)rhs.m_UNK07[i] << std::dec << ",\n";
    }
    os << ")\n";
...
std::ostream& operator<<(std::ostream& os, const MoMMagicDataSegment& rhs)
{
    ...
    {
        os << "[" << i << "] " << (unsigned)rhs.m_UNK_2F[i] << " 0x" << std::hex << (unsigned)rhs.m_UNK_2F[i] << std::dec << ",\n";
    }
    os << ")\n";
    os << "m_Wizard_Types=(\n";
...
std::ostream& operator<<(std::ostream& os, const Node_Attr& rhs)
{
    ...
    os << "m_Plane=" << rhs.m_Plane << "\n";
    os << "m_Owner=" << rhs.m_Owner << "\n";
    os << "m_Power_Node=" << (unsigned)rhs.m_Power_Node << " 0x" << std::hex << (unsigned)rhs.m_Power_Node << std::dec << "\n";
    os << "m_XPos_Mana=(\n";
    for (unsigned i = 0; i < 20; ++i)
    {
        os << "[" << i << "] " << (unsigned)rhs.m_XPos_Mana[i] << " 0x" << std::hex << (unsigned)rhs.m_XPos_Mana[i] << std::dec << ",\n";
    }
    os << ")\n";
    os << "m_YPos_Mana=(\n";
    for (unsigned i = 0; i < 20; ++i)
    {
        os << "[" << i << "] " << (unsigned)rhs.m_YPos_Mana[i] << " 0x" << std::hex << (unsigned)rhs.m_YPos_Mana[i] << std::dec << ",\n";
    }
    os << ")\n";
...
std::ostream& operator<<(std::ostream& os, const Spell_Data& rhs)
{
    ...
    os << "m_UNK01=" << (int)rhs.m_UNK01 << " 0x" << std::hex << (int)rhs.m_UNK01 << std::dec << "\n";
...
std::ostream& operator<<(std::ostream& os, const Tower_Attr& rhs)
{
    ...
    os << "m_UNK=" << (unsigned)rhs.m_UNK << " 0x" << std::hex << (unsigned)rhs.m_UNK << std::dec << "\n";
    os << "}";
    return os;
}
...
std::ostream& operator<<(std::ostream& os, const Unit& rhs)
{
    ...
    os << "m_Grouping=" << (unsigned)rhs.m_Grouping << " 0x" << std::hex << (unsigned)rhs.m_Grouping << std::dec << "\n";
...
std::ostream& operator<<(std::ostream& os, const Unit_Type_Data& rhs)
{
    ...
    os << "m_Immunity_Flags=" << rhs.m_Immunity_Flags << "\n";
    os << "m_Attribute_Flags=" << rhs.m_Attribute_Flags << "\n";
    os << "m_Zero03=" << (unsigned)rhs.m_Zero03 << " 0x" << std::hex << (unsigned)rhs.m_Zero03 << std::dec << "\n";
    os << "m_Ability_Flags=" << rhs.m_Ability_Flags << "\n";
    os << "m_Attack_Flags=" << rhs.m_Attack_Flags << "\n";
    os << "m_UNK02=" << (unsigned)rhs.m_UNK02 << " 0x" << std::hex << (unsigned)rhs.m_UNK02 << std::dec << "\n";
    os << "m_Zero04=" << (unsigned)rhs.m_Zero04 << " 0x" << std::hex << (unsigned)rhs.m_Zero04 << std::dec << "\n";
    os << "}";
    return os;
}
...
std::ostream& operator<<(std::ostream& os, const Wizard& rhs)
{
    ...
    for (unsigned i = 0; i < 8; ++i)
    {
        os << "[" << i << "] " << (unsigned)rhs.m_UNK01C[i] << " 0x" << std::hex << (unsigned)rhs.m_UNK01C[i] << std::dec << ",\n";
    }
    os << ")\n";
    os << "m_Fame=" << rhs.m_Fame << " 0x" << std::hex << rhs.m_Fame << std::dec << "\n";
    os << "m_Power_Base=" << rhs.m_Power_Base << " 0x" << std::hex << rhs.m_Power_Base << std::dec << "\n";
    os << "m_UNK028=" << rhs.m_UNK028 << " 0x" << std::hex << rhs.m_UNK028 << std::dec << "\n";
    ...
    for (unsigned i = 0; i < 4; ++i)
    {
        os << "[" << i << "] " << (unsigned)rhs.m_UNK044[i] << " 0x" << std::hex << (unsigned)rhs.m_UNK044[i] << std::dec << ",\n";
    }
    os << ")\n";
    ...
    os << ")\n";
    os << "m_UNK11E=" << rhs.m_UNK11E << " 0x" << std::hex << rhs.m_UNK11E << std::dec << "\n";
    os << "m_Items_in_Slots=(\n";
    for (unsigned i = 0; i < 4; ++i)
    {
    ...
    {
        os << "[" << i << "] " << (int)rhs.m_Unk15E[i] << " 0x" << std::hex << (int)rhs.m_Unk15E[i] << std::dec << ",\n";
    }
    os << ")\n";
    os << "m_Unk182_Relation=(\n";
    for (unsigned i = 0; i < 6; ++i)
    {
        os << "[" << i << "] " << (int)rhs.m_Unk182_Relation[i] << " 0x" << std::hex << (int)rhs.m_Unk182_Relation[i] << std::dec << ",\n";
    }
    os << ")\n";
    os << "m_Unk188_Relation=(\n";
    for (unsigned i = 0; i < 6; ++i)
    {
        os << "[" << i << "] " << (int)rhs.m_Unk188_Relation[i] << " 0x" << std::hex << (int)rhs.m_Unk188_Relation[i] << std::dec << ",\n";
    }
    os << ")\n";
    os << "m_Unk18E=(\n";
    for (unsigned i = 0; i < 18; ++i)
    {
        os << "[" << i << "] " << (int)rhs.m_Unk18E[i] << " 0x" << std::hex << (int)rhs.m_Unk18E[i] << std::dec << ",\n";
    }
    os << ")\n";
    ...
    {
        os << "[" << i << "] " << (int)rhs.m_Unk1A6[i] << " 0x" << std::hex << (int)rhs.m_Unk1A6[i] << std::dec << ",\n";
    }
    os << ")\n";
    ...
    {
        os << "[" << i << "] " << (int)rhs.m_UNK33A[i] << " 0x" << std::hex << (int)rhs.m_UNK33A[i] << std::dec << ",\n";
    }
    os << ")\n";
    os << "m_UNK354=" << (int)rhs.m_UNK354 << " 0x" << std::hex << (int)rhs.m_UNK354 << std::dec << "\n";
    os << "m_UNK355=" << (int)rhs.m_UNK355 << " 0x" << std::hex << (int)rhs.m_UNK355 << std::dec << "\n";
    os << "m_Gold_Coins=" << rhs.m_Gold_Coins << " 0x" << std::hex << rhs.m_Gold_Coins << std::dec << "\n";
    os << "m_UNK358=" << rhs.m_UNK358 << " 0x" << std::hex << rhs.m_UNK358 << std::dec << "\n";
    ...
    {
        os << "[" << i << "] " << (unsigned)rhs.m_Historian[i] << " 0x" << std::hex << (unsigned)rhs.m_Historian[i] << std::dec << ",\n";
    }
    os << ")\n";
    ...
    {
        os << "[" << i << "] " << (unsigned)rhs.m_UNK49A[i] << " 0x" << std::hex << (unsigned)rhs.m_UNK49A[i] << std::dec << ",\n";
    }
    os << ")\n";
    os << "m_Books_Color=" << rhs.m_Books_Color << "\n";
    os << "m_Zero4C5=" << (unsigned)rhs.m_Zero4C5 << " 0x" << std::hex << (unsigned)rhs.m_Zero4C5 << std::dec << "\n";
    os << "m_UNK4C6=" << rhs.m_UNK4C6 << " 0x" << std::hex << rhs.m_UNK4C6 << std::dec << "\n";
    os << "}";
    return os;
}
...
bool validate(const eBannerColor& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case BANNER_Blue: break;
    case BANNER_Green: break;
    case BANNER_Purple: break;
    case BANNER_Red: break;
...
bool validate(const eBattleCondition& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case BATTLECONDITION_other: break;
    case BATTLECONDITION_strategic_city_combat: break;
    case BATTLECONDITION_sorcery_node: break;
    case BATTLECONDITION_nature_node: break;
    case BATTLECONDITION_chaos_node: break;
    case BATTLECONDITION_sea: break;
    default: std::cout << context << ": Unknown eBattleCondition = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eBuilding& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case BUILDING_Not_applicable: break;
    case BUILDING_None: break;
    case BUILDING_Trade_Goods: break;
    case BUILDING_Housing: break;
    case BUILDING_Barracks: break;
    case BUILDING_Armory: break;
    case BUILDING_Fighters_Guild: break;
    case BUILDING_Armorers_Guild: break;
    case BUILDING_War_College: break;
    case BUILDING_Smithy: break;
    case BUILDING_Stable: break;
    case BUILDING_Animists_Guild: break;
    case BUILDING_Fantastic_Stable: break;
    case BUILDING_Shipwright_Guild: break;
    case BUILDING_Ship_Yard: break;
    case BUILDING_Maritime_Guild: break;
    case BUILDING_Sawmill: break;
    case BUILDING_Library: break;
    case BUILDING_Sages_Guild: break;
    case BUILDING_Oracle: break;
    case BUILDING_Alchemist_Guild: break;
    case BUILDING_University: break;
    case BUILDING_Wizards_Guild: break;
    case BUILDING_Shrine: break;
    case BUILDING_Temple: break;
    case BUILDING_Parthenon: break;
    case BUILDING_Cathedral: break;
    case BUILDING_Marketplace: break;
    case BUILDING_Bank: break;
    case BUILDING_Merchants_Guild: break;
    case BUILDING_Granary: break;
    case BUILDING_Farmers_Market: break;
    case BUILDING_Foresters_Guild: break;
    case BUILDING_Builders_Hall: break;
...
bool validate(const eBuildingStatus& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case BUILDINGSTATUS_Not_Built: break;
    case BUILDINGSTATUS_Replaced: break;
...
bool validate(const eCentralStructure& rhs, const std::string& context)
{
    bool ok = true;
    switch (rhs)
    {
    case CENTRALSTRUCTURE_none: break;
    case CENTRALSTRUCTURE_outpost: break;
    case CENTRALSTRUCTURE_city_grid: break;
    case CENTRALSTRUCTURE_wizards_fortress: break;
    case CENTRALSTRUCTURE_small_tower: break;
    case CENTRALSTRUCTURE_tower_between_planes: break;
    case CENTRALSTRUCTURE_cave: break;
    case CENTRALSTRUCTURE_temple: break;
    case CENTRALSTRUCTURE_medium_tower: break;
    case CENTRALSTRUCTURE_sorcery_node: break;
    case CENTRALSTRUCTURE_chaos_node: break;
    case CENTRALSTRUCTURE_nature_node: break;
    case CENTRALSTRUCTURE_ruins: break;
    default: std::cout << context << ": Unknown eCentralStructure = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eCityWall& rhs, const std::string& context)
{
    bool ok = true;
    switch (rhs)
    {
    case CITYWALL_type1_first: break;
    case CITYWALL_type2_first: break;
    case CITYWALL_type3_first: break;
    case CITYWALL_walloffire_first: break;
    case CITYWALL_wallofdarkness_first: break;
    default: std::cout << context << ": Unknown eCityWall = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eCity_Size& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case CITYSIZE_Outpost: break;
    case CITYSIZE_Hamlet: break;
    case CITYSIZE_Village: break;
    case CITYSIZE_Town: break;
    case CITYSIZE_City: break;
    case CITYSIZE_Capital: break;
    default: std::cout << context << ": Unknown eCity_Size = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eCombatEnchantment& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case COMBATENCHANTMENT_Vertigo: break;
    case COMBATENCHANTMENT_Confusion: break;
    case COMBATENCHANTMENT_Whirlwind: break;
    case COMBATENCHANTMENT_Mind_Storm: break;
    case COMBATENCHANTMENT_Shatter: break;
    case COMBATENCHANTMENT_Weakness: break;
    case COMBATENCHANTMENT_Black_Sleep: break;
    case COMBATENCHANTMENT_Warp_Creature_Attack: break;
    case COMBATENCHANTMENT_Warp_Creature_Defense: break;
    case COMBATENCHANTMENT_Warp_Creature_Resistance: break;
    case COMBATENCHANTMENT_Mind_Twist: break;
    case COMBATENCHANTMENT_Haste: break;
    case COMBATENCHANTMENT_Web: break;
    case COMBATENCHANTMENT_Creature_Binding: break;
    case COMBATENCHANTMENT_Possession: break;
    case COMBATENCHANTMENT_No_Effect80: break;
    default: std::cout << context << ": Unknown eCombatEnchantment = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eDifficulty& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case DIFFICULTY_Tutorial: break;
    case DIFFICULTY_Easy: break;
...
bool validate(const eEvent& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case EVENT_Meteor: break;
    case EVENT_Gift_from_the_Gods: break;
    case EVENT_Disjunction: break;
    case EVENT_Diplomatic_Marriage: break;
    case EVENT_Earthquake: break;
    case EVENT_Pirates: break;
    case EVENT_Plague: break;
    case EVENT_Rebellion: break;
    case EVENT_Donation: break;
    case EVENT_Depletion: break;
    case EVENT_Mine_found: break;
    case EVENT_Population_Boom: break;
    case EVENT_Good_Moon: break;
    case EVENT_Bad_Moon: break;
    case EVENT_Conjunction_Sorcery: break;
    case EVENT_Conjunction_Nature: break;
    case EVENT_Conjunction_Chaos: break;
    case EVENT_Mana_Short: break;
    default: std::cout << context << ": Unknown eEvent = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eGameState& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case STATE_City_display: break;
    case STATE_Game: break;
    case STATE_Armies: break;
    case STATE_Cities: break;
    case STATE_Exit: break;
    case STATE_Main: break;
    case STATE_Magic: break;
    case STATE_Road_Building_You: break;
    case STATE_Change: break;
    case STATE_Item_You: break;
    case STATE_Next_turn_seq: break;
    case STATE_11_default: break;
    case STATE_Spells: break;
    case STATE_13_default: break;
    case STATE_Info: break;
...
bool validate(const eGrand_Vizier& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case GRANDVIZIER_Off: break;
    case GRANDVIZIER_On: break;
    default: std::cout << context << ": Unknown eGrand_Vizier = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eHelpIndex& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case eHelpIndex_NONE: break;
    case HELP_EXIT_SPELL_BOOK: break;
    case HELP_EARTH_TO_MUD: break;
    case HELP_RESIST_ELEMENTS: break;
    case HELP_WALL_OF_STONE: break;
    case HELP_GIANT_STRENGTH: break;
    case HELP_WEB: break;
    case HELP_figure12_WAR_BEARS: break;
    case HELP_STONE_SKIN: break;
    case HELP_WATER_WALKING: break;
    case HELP_figure13_SPRITES: break;
    case HELP_EARTH_LORE: break;
    case HELP_CRACKS_CALL: break;
    case HELP_NATURES_EYE: break;
    case HELP_ICE_BOLT: break;
    case HELP_figure13_GIANT_SPIDERS: break;
    case HELP_CHANGE_TERRAIN: break;
    case HELP_PATH_FINDING: break;
    case HELP_figure13_COCKATRICES: break;
    case HELP_TRANSMUTE: break;
    case HELP_NATURES_CURES: break;
    case HELP_figure13_BASILISKS: break;
    case HELP_ELEMENTAL_ARMOR: break;
    case HELP_PETRIFY: break;
    case HELP_figure13_STONE_GIANT: break;
    case HELP_IRON_SKIN: break;
    case HELP_ICE_STORM: break;
    case HELP_EARTHQUAKE: break;
    case HELP_figure13_GORGONS: break;
    case HELP_MOVE_FORTRESS: break;
    case HELP_GAIAS_BLESSING: break;
    case HELP_figure13_EARTH_ELEMENTAL: break;
    case HELP_REGENERATION: break;
    case HELP_figure13_BEHEMOTH: break;
    case HELP_ENTANGLE: break;
    case HELP_NATURES_AWARENESS: break;
    case HELP_CALL_LIGHTNING: break;
    case HELP_figure13_COLOSSUS: break;
    case HELP_EARTH_GATE: break;
    case HELP_HERB_MASTERY: break;
    case HELP_figure13_GREAT_WYRM: break;
    case HELP_NATURES_WRATH: break;
    case HELP_RESIST_MAGIC: break;
    case HELP_DISPEL_MAGIC_TRUE: break;
    case HELP_FLOATING_ISLANDS: break;
    case HELP_GUARDIAN_WIND: break;
    case HELP_Figure13_PHANTOM_WARRIORS: break;
    case HELP_CONFUSION: break;
    case HELP_WORD_OF_RECALL: break;
    case HELP_COUNTER_MAGIC: break;
    case HELP_figure14_NAGAS: break;
    case HELP_PSIONIC_BLAST: break;
    case HELP_BLUR: break;
    case HELP_DISENCHANT_TRUE: break;
    case HELP_VERTIGO: break;
    case HELP_SPELL_LOCK: break;
    case HELP_ENCHANT_ROAD: break;
    case HELP_FLIGHT: break;
    case HELP_WIND_MASTERY: break;
    case HELP_SPELL_BLAST: break;
    case HELP_AURA_OF_MAJESTY: break;
    case HELP_Figure13_PHANTOM_BEAST: break;
    case HELP_DISJUNCTION_TRUE: break;
    case HELP_INVISIBILITY: break;
    case HELP_WIND_WALKING: break;
    case HELP_BANISH: break;
    case HELP_Figure13_STORM_GIANT: break;
    case HELP_Figure13_AIR_ELEMENTAL: break;
    case HELP_MIND_STORM: break;
    case HELP_STASIS: break;
    case HELP_MAGIC_IMMUNITY: break;
    case HELP_HASTE: break;
    case HELP_figure14_DJINN: break;
    case HELP_SPELL_WARD: break;
    case HELP_CREATURE_BINDING: break;
    case HELP_MASS_INVISIBILITY: break;
    case HELP_GREAT_UNSUMMONING: break;
    case HELP_SPELL_BINDING: break;
    case HELP_FLYING_FORTRESS: break;
    case HELP_Figure14_SKY_DRAKE: break;
    case HELP_SUPPRESS_MAGIC: break;
    case HELP_TIME_STOP: break;
    case HELP_WARP_WOOD: break;
    case HELP_DISRUPT: break;
    case HELP_FIRE_BOLT: break;
    case HELP_figure11_HELL_HOUNDS: break;
    case HELP_CORRUPTION: break;
    case HELP_spell_SPECIAL_ELDRITCH_WEAPON: break;
    case HELP_WALL_OF_FIRE: break;
    case HELP_spell_SPECIAL_SHATTER: break;
    case HELP_spell_SPECIAL2_WARP_CREATURE: break;
    case HELP_figure11_FIRE_ELEMENTAL: break;
    case HELP_LIGHTNING_BOLT: break;
    case HELP_Figure11_FIRE_GIANT: break;
    case HELP_spell_SPECIAL_CHAOS_CHANNELS: break;
    case HELP_spell_SPECIAL_FLAME_BLADE: break;
    case HELP_figure11_GARGOYLES: break;
    case HELP_FIREBALL: break;
    case HELP_figure11_DOOM_BAT: break;
    case HELP_RAISE_VOLCANO: break;
    case HELP_spell_SPECIAL2_IMMOLATION: break;
    case HELP_Figure11_CHIMERA: break;
    case HELP_WARP_LIGHTNING: break;
    case HELP_spell_COMPIX_METAL_FIRES: break;
    case HELP_figure11_CHAOS_SPAWN: break;
    case HELP_DOOM_BOLT: break;
    case HELP_MAGIC_VORTEX: break;
    case HELP_Figure11_EFREET: break;
    case HELP_FIRE_STORM: break;
    case HELP_spell_COMPIX_WARP_REALITY: break;
    case HELP_FLAME_STRIKE: break;
    case HELP_CHAOS_RIFT: break;
    case HELP_Figure11_HYDRA: break;
    case HELP_DISINTEGRATE: break;
    case HELP_METEOR_STORM: break;
    case HELP_GREAT_WASTING: break;
    case HELP_CALL_CHAOS: break;
    case HELP_CHAOS_SURGE: break;
    case HELP_DOOM_MASTERY: break;
    case HELP_figure11_GREAT_DRAKE: break;
    case HELP_CALL_THE_VOID: break;
    case HELP_ARMAGEDON: break;
    case HELP_BLESS: break;
    case HELP_STAR_FIRES: break;
    case HELP_ENDURANCE: break;
    case HELP_HOLY_WEAPON: break;
    case HELP_HEALING: break;
    case HELP_HOLY_ARMOR: break;
    case HELP_JUST_CAUSE: break;
    case HELP_TRUE_LIGHT: break;
    case HELP_figure12_GUARDIAN_SPIRIT: break;
    case HELP_HEROISM: break;
    case HELP_TRUE_SIGHT: break;
    case HELP_PLANE_SHIFT: break;
    case HELP_RESURRECTION: break;
    case HELP_DISPEL_EVIL: break;
    case HELP_PLANAR_SEAL: break;
    case HELP_Figure12_UNICORNS: break;
    case HELP_RAISE_DEAD: break;
    case HELP_PLANAR_TRAVEL: break;
    case HELP_HEAVENLY_LIGHT: break;
    case HELP_PRAYER: break;
    case HELP_LION_HEART: break;
    case HELP_figures3_INCARNATION: break;
    case HELP_INVULNERABILITY: break;
    case HELP_RIGHTEOUSNESS: break;
    case HELP_PROSPERITY: break;
    case HELP_ALTAR_OF_BATTLE: break;
    case HELP_figure12_ANGEL: break;
    case HELP_STREAM_OF_LIFE: break;
    case HELP_MASS_HEALING: break;
    case HELP_HOLY_WORD: break;
    case HELP_HIGH_PRAYER: break;
    case HELP_INSPIRATIONS: break;
    case HELP_ASTRAL_GATE: break;
    case HELP_HOLY_ARMS: break;
    case HELP_CONSECRATION: break;
    case HELP_LIFE_FORCE: break;
    case HELP_TRANQUILITY: break;
    case HELP_CRUSADE: break;
    case HELP_figure12_ARCHANGEL: break;
    case HELP_CHARM_OF_LIFE: break;
    case HELP_Figure12_SKELETONS: break;
    case HELP_spell_SPECIAL_WEAKNESS: break;
    case HELP_DARK_RITUALS: break;
    case HELP_spell_SPECIAL_CLOAK_OF_FEAR: break;
    case HELP_spell_SPECIAL2_BLACK_SLEEP: break;
    case HELP_Figure12_GHOULS: break;
    case HELP_LIFE_DRAIN: break;
    case HELP_TERROR: break;
    case HELP_spell_COMPIX_DARKNESS: break;
    case HELP_MANA_LEAK: break;
    case HELP_DRAIN_POWER: break;
    case HELP_spell_SPECIAL_POSSESSION: break;
    case HELP_Figure12_LYCANTHROPY: break;
    case HELP_spell_COMPIX_BLACK_PRAYER: break;
    case HELP_spell_SPECIAL_BLACK_CHANNELS: break;
    case HELP_Figure12_NIGHT_STALKER: break;
    case HELP_SUBVERSION: break;
    case HELP_WALL_OF_DARKNESS: break;
    case HELP_spell_SPECIAL2_BERSERK: break;
    case HELP_Figure12_SHADOW_DEMONS: break;
    case HELP_spell_SPECIAL_WRAITH_FORM: break;
    case HELP_spell_COMPIX_WRACK: break;
    case HELP_EVIL_PRESENCE: break;
    case HELP_Figure12_WRAITHS: break;
    case HELP_CLOUD_OF_SHADOW: break;
    case HELP_WARP_NODE: break;
    case HELP_BLACK_WIND: break;
    case HELP_Figure12_ZOMBIE_MASTERY: break;
    case HELP_FAMINE: break;
    case HELP_CURSED_LANDS: break;
    case HELP_CRUEL_UNMINDING: break;
    case HELP_WORD_OF_DEATH: break;
    case HELP_Figure12_DEATH_KNIGHTS: break;
    case HELP_DEATH_SPELL: break;
    case HELP_ANIMATE_DEAD: break;
    case HELP_PESTILENCE: break;
    case HELP_ETERNAL_NIGHT: break;
    case HELP_EVIL_OMENS: break;
    case HELP_DEATH_WISH: break;
    case HELP_Figure12_DEMON_LORD: break;
    case HELP_figure11_MAGIC_SPIRIT: break;
    case HELP_DISPEL_MAGIC: break;
    case HELP_spell_cityscap_SUMMONING_CIRCLE: break;
    case HELP_DISENCHANT_AREA: break;
    case HELP_RECALL_HERO: break;
    case HELP_DETECT_MAGIC: break;
    case HELP_ENCHANT_ITEM: break;
    case HELP_SUMMON_HERO: break;
    case HELP_AWARENESS: break;
    case HELP_DISJUNCTION: break;
    case HELP_CREATE_ARTIFACT: break;
    case HELP_SUMMON_CHAMPION: break;
    case HELP_spell_SPELL_OF_MASTERY: break;
    case HELP_SPECIAL2_PAGE_BACK: break;
    case HELP_SPECIAL2_PAGE_FORWARD: break;
    case HELP_MAIN_GAME: break;
    case HELP_MAIN_SPELLS: break;
    case HELP_MAIN_ARMIES: break;
    case HELP_MAIN_CITIES: break;
    case HELP_MAIN_MAGIC: break;
    case HELP_MAIN_INFORMATION: break;
    case HELP_MAIN_PLANE: break;
    case HELP_MAIN_DONE: break;
    case HELP_MAIN_PATROL: break;
    case HELP_MAIN_WAIT: break;
    case HELP_MAIN_BUILD: break;
    case HELP_MAIN_PURIFY: break;
    case HELP_MAIN_MELD: break;
    case HELP_NEXT_TURN: break;
    case HELP_REDUCED_MAP: break;
    case HELP_TOTAL_GOLD: break;
    case HELP_TOTAL_MANA: break;
    case HELP_GOLD_INCOME: break;
    case HELP_FOOD_RESERVE: break;
    case HELP_MANA_INCOME: break;
    case HELP_MOVES: break;
    case HELP_1_REDUCED_MAP: break;
    case HELP_UNIT_NAME: break;
    case HELP_UNIT_ENCHANTMENTS: break;
    case HELP_ARMYLIST_ITEMS: break;
    case HELP_1_ARMYLIST_OK: break;
    case HELP_1_UPKEEP: break;
    case HELP_EMPTY_HERO_SLOT: break;
    case HELP_ARMYLIST_UP_ARROW: break;
    case HELP_ARMYLIST_DOWN_ARROW: break;
    case HELP_ANVIL: break;
    case HELP_ARMYLIST_ALCHEMY: break;
    case HELP_2_ARMYLIST_OK: break;
    case HELP_2_REDUCED_MAP: break;
    case HELP_2_CITY_NAME: break;
    case HELP_CITY_ENCHANTMENTS: break;
    case HELP_RELOAD_OK: break;
    case HELP_MAIN_WALKING: break;
    case HELP_MAIN_FORESTER: break;
    case HELP_MAIN_MOUNTAINEER: break;
    case HELP_MAIN_FLYING: break;
    case HELP_MAIN_PATHFINDING: break;
    case HELP_MAIN_SWIMMING: break;
    case HELP_MAIN_SAILING: break;
    case HELP_MAIN_WIND_WALKING: break;
    case HELP_MAIN_PLANAR_TRAVEL: break;
    case HELP_MAGIC_GRAY_GEM: break;
    case HELP_MAGIC_SHATTERED_GEM: break;
    case HELP_POWER_DISTRIBUTION: break;
    case HELP_CASTING_SKILL_RATIO: break;
    case HELP_MANA_POINTS_RATIO: break;
    case HELP_RESEARCH_RATIO: break;
    case HELP_MAGIC_ALCHEMY: break;
    case HELP_3_MAGIC_OK: break;
    case HELP_3_ENCHANTMENTS: break;
    case HELP_RELATIONS: break;
    case HELP_WIZARD_STATISTICS_delete: break;
    case HELP_SPELL_CASTING_SKILL: break;
    case HELP_MAGIC_RESERVE: break;
    case HELP_POWER_BASE: break;
    case HELP_CASTING_1: break;
    case HELP_RESEARCHING: break;
    case HELP_SUMMON_TO: break;
    case HELP_BARBARIAN_TOWNSFOLK: break;
    case HELP_BEASTMEN_TOWNSFOLK: break;
    case HELP_DARK_ELF_TOWNSFOLK: break;
    case HELP_DRACONIAN_TOWNSFOLK: break;
    case HELP_DWARF_TOWNSFOLK: break;
    case HELP_GNOLL_TOWNSFOLK: break;
    case HELP_HALFLING_TOWNSFOLK: break;
    case HELP_HIGH_ELF_TOWNSFOLK: break;
    case HELP_HIGH_MEN_TOWNSFOLK: break;
    case HELP_KLACKON_TOWNSFOLK: break;
    case HELP_LIZARDMEN_TOWNSFOLK: break;
    case HELP_NOMAD_TOWNSFOLK: break;
    case HELP_ORC_TOWNSFOLK: break;
    case HELP_TROLL_TOWNSFOLK: break;
    case HELP_3_CITY_NAME: break;
    case HELP_CITY_RESOURCES_delete: break;
    case HELP_BACKGRND_FOOD: break;
    case HELP_BACKGRND_PRODUCTION: break;
    case HELP_BACKGRND_GOLD: break;
    case HELP_BACKGRND_GOLD_MAINTENANCE: break;
    case HELP_BACKGRND_MAGICAL_POWER: break;
    case HELP_BACKGRND_SPELL_RESEARCH: break;
    case HELP_4_ENCHANTMENTS: break;
    case HELP_CITY_VIEW: break;
    case HELP_4_CITY_SCAPE: break;
    case HELP_PRODUCING: break;
    case HELP_BACKGRND_BUY: break;
    case HELP_BACKGRND_CHANGE: break;
    case HELP_BACKGRND_OK: break;
    case HELP_BACKGRND_Barbarian_Farmers: break;
    case HELP_BACKGRND_Barbarian_Workers: break;
    case HELP_BACKGRND_Barbarian_Rebels: break;
    case HELP_BACKGRND_Beastmen_Farmers: break;
    case HELP_BACKGRND_Beastmen_Workers: break;
    case HELP_BACKGRND_Beastmen_Rebels: break;
    case HELP_BACKGRND_Dark_Elf_Farmers: break;
    case HELP_BACKGRND_Dark_Elf_Workers: break;
    case HELP_BACKGRND_Dark_Elf_Rebels: break;
    case HELP_BACKGRND_Draconian_Farmers: break;
    case HELP_BACKGRND_Draconian_Workers: break;
    case HELP_BACKGRND_Draconian_Rebels: break;
    case HELP_BACKGRND_Dwarf_Farmers: break;
    case HELP_BACKGRND_Dwarf_Workers: break;
    case HELP_BACKGRND_Dwarf_Rebels: break;
    case HELP_BACKGRND_Gnoll_Farmers: break;
    case HELP_BACKGRND_Gnoll_Workers: break;
    case HELP_BACKGRND_Gnoll_Rebels: break;
    case HELP_BACKGRND_Halfling_Farmers: break;
    case HELP_BACKGRND_Halfling_Workers: break;
    case HELP_BACKGRND_Halfling_Rebels: break;
    case HELP_BACKGRND_High_Elf_Farmers: break;
    case HELP_BACKGRND_High_Elf_Workers: break;
    case HELP_BACKGRND_High_Elf_Rebels: break;
    case HELP_BACKGRND_High_Men_Farmers: break;
    case HELP_BACKGRND_High_Men_Workers: break;
    case HELP_BACKGRND_High_Men_Rebels: break;
    case HELP_BACKGRND_Klackon_Farmers: break;
    case HELP_BACKGRND_Klackon_Workers: break;
    case HELP_BACKGRND_Klackon_Rebels: break;
    case HELP_BACKGRND_Lizardmen_Farmers: break;
    case HELP_BACKGRND_Lizardmen_Workers: break;
    case HELP_BACKGRND_Lizardmen_Rebels: break;
    case HELP_BACKGRND_Nomad_Farmers: break;
    case HELP_BACKGRND_Nomad_Workers: break;
    case HELP_BACKGRND_Nomad_Rebels: break;
    case HELP_BACKGRND_Orc_Farmers: break;
    case HELP_BACKGRND_Orc_Workers: break;
    case HELP_BACKGRND_Orc_Rebels: break;
    case HELP_BACKGRND_Troll_Farmers: break;
    case HELP_BACKGRND_Troll_Workers: break;
    case HELP_BACKGRND_Troll_Rebels: break;
    case HELP_PORTRAIT: break;
    case HELP_NAME: break;
    case HELP_STATISTICS: break;
    case HELP_GOLD: break;
    case HELP_MANA_1: break;
    case HELP_SPELL_RANKS: break;
    case HELP_SPECIAL_ABILITIES: break;
    case HELP_HEROES: break;
    case HELP_PLANE: break;
    case HELP_MAP: break;
    case HELP_CLOSE: break;
    case HELP_CHANGE_PLANES: break;
    case HELP_MAP_KEY: break;
    case HELP_POWER_GRAPH: break;
    case HELP_STATUS: break;
    case HELP_MAGIC_POWER: break;
    case HELP_SPELL_RESEARCH: break;
    case HELP_ARMY_STRENGTH: break;
    case HELP_ALCHEMY_GOLD: break;
    case HELP_MAGIC_ALCHEMY_RATIO: break;
    case HELP_ALCHEMY_POWER: break;
    case HELP_MAGIC_CANCEL: break;
    case HELP_MAGIC_ALCHEMY_TOGGLE: break;
    case HELP_4_MAGIC_OK: break;
    case HELP_BUILDING_OPTIONS: break;
    case HELP_UNIT_OPTIONS: break;
    case HELP_1_CANCEL: break;
    case HELP_1_OK: break;
    case HELP_BUILDING_DESCRIPTION: break;
    case HELP_ALLOWS: break;
    case HELP_MAINTENANCE: break;
    case HELP_COST: break;
    case HELP_UNIT_MOVES: break;
    case HELP_MELEE: break;
    case HELP_UNITVIEW_Sword: break;
    case HELP_UNITVIEW_Magic_Weapon: break;
    case HELP_UNITVIEW_Mithril_Weapon: break;
    case HELP_RANGE_1: break;
    case HELP_UNITVIEW_THROWN_delete: break;
    case HELP_UNITVIEW_Bow: break;
    case HELP_UNITVIEW_Rock: break;
    case HELP_UNITVIEW_Magical_Attack: break;
    case HELP_UNITVIEW_MAGICAL_BREATH_delete: break;
    case HELP_UNITVIEW_ARMOR: break;
    case HELP_UNITVIEW_RESISTANCE: break;
    case HELP_UNITVIEW_HITS: break;
    case HELP_SPECIAL_LARGE_SHIELD: break;
    case HELP_SPECIAL_PLANE_SHIFT: break;
    case HELP_SPECIAL_WALL_CRUSHER: break;
    case HELP_SPECIAL_HEALER: break;
    case HELP_SPECIAL_CREATE_OUTPOST: break;
    case HELP_SPECIAL_INVISIBILITY_1: break;
    case HELP_SPECIAL_CREATE_UNDEAD: break;
    case HELP_SPECIAL2_LONG_RANGE: break;
    case HELP_SPECIAL_LAND_CORRUPTION: break;
    case HELP_SPECIAL_MELD_WITH_NODE: break;
    case HELP_SPECIAL_NON_CORPOREAL: break;
    case HELP_SPECIAL_WIND_WALKING_1: break;
    case HELP_SPECIAL_REGENERATION: break;
    case HELP_SPECIAL_PURIFY: break;
    case HELP_SPECIAL_NEGATE_FIRST_STRIKE: break;
    case HELP_SPECIAL2_LUCKY: break;
    case HELP_SPECIAL_POISON_IMMUNITY: break;
    case HELP_SPECIAL_FIRE_IMMUNITY: break;
    case HELP_SPECIAL_STONING_IMMUNITY: break;
    case HELP_SPECIAL_WEAPON_IMMUNITY: break;
    case HELP_SPECIAL_MISSILES_IMMUNITY: break;
    case HELP_SPECIAL_ILLUSIONS_IMMUNITY: break;
    case HELP_SPECIAL_COLD_IMMUNITY: break;
    case HELP_SPECIAL_MAGIC_IMMUNITY_1: break;
    case HELP_SPECIAL_DEATH_IMMUNITY: break;
    case HELP_SPECIAL_HEALING_SPELL: break;
    case HELP_SPECIAL_FIRE_BALL_SPELL: break;
    case HELP_SPECIAL_DOOMBOLT_SPELL: break;
    case HELP_SPECIAL_IMMOLATION: break;
    case HELP_SPECIAL2_CAUSE_FEAR_SPELL: break;
    case HELP_SPECIAL2_WEB_SPELL: break;
    case HELP_SPECIAL_RESISTANCE_TO_ALL: break;
    case HELP_SPECIAL_HOLY_BONUS: break;
    case HELP_SPECIAL_ARMOR_PIERCING: break;
    case HELP_SPECIAL_FIRST_STRIKE: break;
    case HELP_SPECIAL_POISON: break;
    case HELP_SPECIAL_LIFE_STEAL: break;
    case HELP_SPECIAL2_CHAOS: break;
    case HELP_SPECIAL2_DESTRUCTION: break;
    case HELP_SPECIAL_ILLUSION: break;
    case HELP_SPECIAL_STONING_TOUCH: break;
    case HELP_SPECIAL2_CAUSE_DEATH: break;
    case HELP_SPECIAL2_POWER_DRAIN: break;
    case HELP_SPECIAL2_DISPEL_EVIL: break;
    case HELP_SPECIAL_CHAOS_CHANNEL_1: break;
    case HELP_SPECIAL_CHAOS_CHANNEL_2: break;
    case HELP_SPECIAL_CHAOS_CHANNEL_3: break;
    case HELP_SPECIAL2_THROWN: break;
    case HELP_SPECIAL2_FIRE_BREATH: break;
    case HELP_SPECIAL2_LIGHTNING_BREATH: break;
    case HELP_SPECIAL_STONING_GAZE: break;
    case HELP_SPECIAL2_DOOM_GAZE: break;
    case HELP_SPECIAL2_DEATH_GAZE: break;
    case HELP_SPECIAL2_IMMOLATION: break;
    case HELP_SPECIAL2_GUARDIAN_WIND: break;
    case HELP_SPECIAL2_BERSERK: break;
    case HELP_SPECIAL_CLOAK_OF_FEAR: break;
    case HELP_SPECIAL_BLACK_CHANNELS: break;
    case HELP_SPECIAL_WRAITH_FORM: break;
    case HELP_SPECIAL_REGENERATE: break;
    case HELP_SPECIAL_PATHFINDING_1: break;
    case HELP_SPECIAL_WATER_WALKING: break;
    case HELP_SPECIAL_ELEMENTAL_ARMOR: break;
    case HELP_SPECIAL_RESIST_ELEMENTS: break;
    case HELP_SPECIAL_STONE_SKIN: break;
    case HELP_SPECIAL_IRON_SKIN: break;
    case HELP_SPECIAL_ENDURANCE: break;
    case HELP_SPECIAL2_SPELL_LOCK: break;
    case HELP_SPECIAL_INVISIBILITY_2: break;
    case HELP_SPECIAL_WIND_WALKING_2: break;
    case HELP_SPECIAL_FLIGHT: break;
    case HELP_SPECIAL_RESIST_MAGIC: break;
    case HELP_SPECIAL_MAGIC_IMMUNITY_2: break;
    case HELP_SPECIAL_FLAME_BLADE: break;
    case HELP_SPECIAL_ELDRITCH_WEAPON: break;
    case HELP_SPECIAL_TRUE_SIGHT: break;
    case HELP_SPECIAL_HOLY_WEAPON: break;
    case HELP_SPECIAL_HEROISM: break;
    case HELP_SPECIAL_BLESS: break;
    case HELP_SPECIAL_LION_HEART: break;
    case HELP_SPECIAL_GIANT_STRENGTH: break;
    case HELP_SPECIAL_PLANAR_TRAVEL: break;
    case HELP_SPECIAL_HOLY_ARMOR: break;
    case HELP_SPECIAL_RIGHTEOUSNESS: break;
    case HELP_SPECIAL_INVULNERABILITY: break;
    case HELP_SPECIAL_VERTIGO: break;
    case HELP_SPECIAL2_CONFUSION: break;
    case HELP_SPECIAL2_WHIRLWIND: break;
    case HELP_SPECIAL2_MIND_STORM: break;
    case HELP_SPECIAL_SHATTER: break;
    case HELP_SPECIAL_WEAKNESS: break;
    case HELP_SPECIAL2_BLACK_SLEEP: break;
    case HELP_SPECIAL2_WARP_CREATURE_1: break;
    case HELP_SPECIAL2_WARP_CREATURE_2: break;
    case HELP_SPECIAL2_WARP_CREATURE_3: break;
    case HELP_SPECIAL2_MANA_LEAK: break;
    case HELP_SPECIAL_HASTE: break;
    case HELP_SPECIAL_WEB: break;
    case HELP_SPECIAL_CREATURE_BINDING: break;
    case HELP_SPECIAL_POSSESSION: break;
    case HELP_2_UPKEEP: break;
    case HELP_UNITVIEW_PAGE_UP: break;
    case HELP_UNITVIEW_PAGE_DOWN: break;
    case HELP_DISMISS: break;
    case HELP_2_OK: break;
    case HELP_2_CITY_SCAPE: break;
    case HELP_CITY_GARRISONS: break;
    case HELP_UNIT_LIST: break;
    case HELP_BACKGRND_OUTPOST_SIZE_1: break;
    case HELP_BACKGRND_OUTPOST_SIZE_2: break;
    case HELP_BACKGRND_OUTPOST_SIZE_3: break;
    case HELP_OUTPOST_SCAPE: break;
    case HELP_MAIN_CANCEL_1: break;
    case HELP_CASTING_2: break;
    case HELP_ROAD_BUILDING: break;
    case HELP_MAIN_OK: break;
    case HELP_MAIN_CANCEL_2: break;
    case HELP_SURVEY: break;
    case HELP_MAIN_CANCEL_3: break;
    case HELP_hero_SPECIAL_LEADERSHIP: break;
    case HELP_hero_SPECIAL_LEGENDARY: break;
    case HELP_hero_SPECIAL_BLADEMASTER: break;
    case HELP_hero_SPECIAL_ARMSMASTER: break;
    case HELP_hero_SPECIAL_CONSTITUTION: break;
    case HELP_hero_SPECIAL_MIGHT: break;
    case HELP_hero_SPECIAL_ARCANE_POWER: break;
    case HELP_hero_SPECIAL_SAGE: break;
    case HELP_hero_SPECIAL_PRAYERMASTER: break;
    case HELP_hero_SPECIAL_LUCKY: break;
    case HELP_hero_SPECIAL_CHARMED: break;
    case HELP_hero_SPECIAL_NOBLE: break;
    case HELP_unit_SPECIAL_RECRUIT: break;
    case HELP_unit_SPECIAL_REGULAR: break;
    case HELP_unit_SPECIAL_VETERAN: break;
    case HELP_unit_SPECIAL_ELITE: break;
    case HELP_unit_SPECIAL_ULTRA_ELITE: break;
    case HELP_unit_SPECIAL_CHAMPION: break;
    case HELP_hero_SPECIAL_HERO: break;
    case HELP_hero_SPECIAL_MYRMIDON: break;
    case HELP_hero_SPECIAL_CAPTAIN: break;
    case HELP_hero_SPECIAL_COMMANDER: break;
    case HELP_hero_SPECIAL_CHAMPION: break;
    case HELP_hero_SPECIAL_LORD: break;
    case HELP_hero_SPECIAL_GRAND_LORD: break;
    case HELP_hero_SPECIAL_SUPER_HERO: break;
    case HELP_hero_SPECIAL_DEMI_GOD: break;
    case HELP_SPECIAL2_QUIVER: break;
    case HELP_SPECIAL2_PLUS_TO_HIT: break;
    case HELP_SPECIAL2_MIN_TO_HIT: break;
    case HELP_SPECIAL_CONSTRUCTION: break;
    case HELP_SPECIAL_SCOUTING: break;
    case HELP_ITEMISC_MERGING_1: break;
    case HELP_SPECIAL_TELEPORTING: break;
    case HELP_SPECIAL_PATHFINDING_2: break;
    case HELP_SPECIAL_MOUNTAINEER: break;
    case HELP_SPECIAL_FORESTER: break;
    case HELP_SPECIAL2_SUMMON_DEMONS: break;
    case HELP_SPECIAL2_UNDEAD: break;
    case HELP_SPECIAL2_STASIS: break;
    case HELP_SPECIAL_CASTER: break;
    case HELP_ITEMISC_MAGIC_IMMUNITY: break;
    case HELP_ITEMISC_REGENERATE: break;
    case HELP_ITEMISC_HASTE: break;
    case HELP_ITEMISC_TRUE_SIGHT: break;
    case HELP_ITEMISC_PATH_FINDING: break;
    case HELP_ITEMISC_WATER_WALKING: break;
    case HELP_ITEMISC_BLESS: break;
    case HELP_ITEMISC_LION_HEART: break;
    case HELP_ITEMISC_INVISIBILITY: break;
    case HELP_ITEMISC_PLANAR_TRAVEL: break;
    case HELP_ITEMISC_ENDURANCE: break;
    case HELP_ITEMISC_RIGHTEOUSNESS: break;
    case HELP_ITEMISC_INVULNERABILITY: break;
    case HELP_ITEMISC_RESIST_ELEMENTS: break;
    case HELP_ITEMISC_ELEMENTAL_ARMOR: break;
    case HELP_ITEMISC_CLOAK_OF_FEAR: break;
    case HELP_ITEMISC_FLIGHT: break;
    case HELP_ITEMISC_RESIST_MAGIC: break;
    case HELP_ITEMISC_GUARDIAN_WIND: break;
    case HELP_ITEMISC_GIANT_STRENGTH: break;
    case HELP_ITEMISC_MERGING_2: break;
    case HELP_ITEMISC_SWORD_SLOT_1: break;
    case HELP_ITEMISC_BOW_SLOT_1: break;
    case HELP_ITEMISC_STAVE_SWORD_SLOT_1: break;
    case HELP_ITEMISC_STAVE_SLOT_1: break;
    case HELP_ITEMISC_ARMOR_SLOT_1: break;
    case HELP_ITEMISC_MISCELLANEOUS_SLOT_1: break;
    case HELP_ITEMISC_SWORD_SLOT_2: break;
    case HELP_ITEMISC_BOW_SLOT_2: break;
    case HELP_ITEMISC_STAVE_SWORD_SLOT_2: break;
    case HELP_ITEMISC_STAVE_SLOT_2: break;
    case HELP_ITEMISC_ARMOR_SLOT_2: break;
    case HELP_ITEMISC_MISCELLANEOUS_SLOT_2: break;
    case HELP_COMPIX_SPELL_BUTTON: break;
    case HELP_COMPIX_WAIT_BUTTON: break;
    case HELP_COMPIX_INFO_BUTTON: break;
    case HELP_COMPIX_AUTO_BUTTON: break;
    case HELP_COMPIX_FLEE_BUTTON: break;
    case HELP_COMPIX_DONE_BUTTON: break;
    case HELP_SKILL: break;
    case HELP_MANA_2: break;
    case HELP_RANGE_2: break;
    case HELP_ATTACKER: break;
    case HELP_DEFENDER: break;
    case HELP_combat_COMPIX_LIGHT: break;
    case HELP_combat_COMPIX_DARKNESS: break;
    case HELP_combat_COMPIX_WARP_REALITY: break;
    case HELP_combat_COMPIX_BLACK_PRAYER: break;
    case HELP_combat_COMPIX_WRACK: break;
    case HELP_combat_COMPIX_METAL_FIRES: break;
    case HELP_combat_COMPIX_PRAYER: break;
    case HELP_combat_COMPIX_HIGH_PRAYER: break;
    case HELP_combat_COMPIX_TERROR: break;
    case HELP_combat_COMPIX_CALL_LIGHTNING: break;
    case HELP_combat_COMPIX_COUNTER_MAGIC: break;
    case HELP_combat_COMPIX_MASS_INVISIBILITY: break;
    case HELP_combat_COMPIX_DISPELS_NON_SORCERY: break;
    case HELP_combat_COMPIX_DISPELS_NON_CHAOS: break;
    case HELP_combat_COMPIX_DISPELS_NON_NATURE: break;
    case HELP_combat_COMPIX_SORCERY_NODE_AURA: break;
    case HELP_combat_COMPIX_CHAOS_NODE_AURA: break;
    case HELP_combat_COMPIX_NATURE_NODE_AURA: break;
    case HELP_combat_COMPIX_CLOUD_OF_DARKNESS: break;
    case HELP_combat_COMPIX_HOLY_LIGHT: break;
    case HELP_combat_COMPIX_CHAOS_SURGE: break;
    case HELP_combat_COMPIX_ETERNAL_NIGHT: break;
    case HELP_combat_COMPIX_CRUSADE: break;
    case HELP_combat_COMPIX_HOLY_ARMS: break;
    case HELP_combat_COMPIX_CHARM_OF_LIFE: break;
    case HELP_combat_COMPIX_ZOMBIE_MASTERY: break;
    case HELP_DAMAGE: break;
    case HELP_hero_SPECIAL2_AGILE: break;
    case HELP_CONTINUE: break;
    case HELP_LOAD: break;
    case HELP_NEW_GAME: break;
    case HELP_QUIT_TO_DOS: break;
    case HELP_COMPIX_ENTANGLE: break;
    case HELP_LOAD_LOAD_BUTTON: break;
    case HELP_LOAD_QUIT_BUTTON: break;
    case HELP_LOAD_SETTINGS_BUTTON: break;
    case HELP_LOAD_SAVE_BUTTON: break;
    case HELP_LOAD_OK_BUTTON: break;
    case HELP_SAVED_GAMES_1: break;
    case HELP_SAVED_GAMES_2: break;
    case HELP_setup_NEWGAME_OK_BUTTON: break;
    case HELP_NEWGAME_CANCEL_BUTTON: break;
    case HELP_DIFFICULTY_LEVEL: break;
    case HELP_difficulty_INTRO: break;
    case HELP_difficulty_EASY: break;
    case HELP_difficulty_NORMAL: break;
    case HELP_difficulty_HARD: break;
    case HELP_difficulty_IMPOSSIBLE: break;
    case HELP_OPPONENTS: break;
    case HELP_LAND_SIZE: break;
    case HELP_land_SMALL: break;
    case HELP_land_MEDIUM: break;
    case HELP_land_LARGE: break;
    case HELP_MAGIC_INTENSITY: break;
    case HELP_nodes_WEAK: break;
    case HELP_nodes_NORMAL: break;
    case HELP_nodes_POWERFUL: break;
    case HELP_SPELL_OF_RETURN: break;
    case HELP_SELECT_A_BANNER: break;
    case HELP_MERLIN: break;
    case HELP_RAVEN: break;
    case HELP_SHAREE: break;
    case HELP_LO_PAN: break;
    case HELP_JAFAR: break;
    case HELP_OBERIC: break;
    case HELP_TAURON: break;
    case HELP_SSSRA: break;
    case HELP_RJAK: break;
    case HELP_FREYA: break;
    case HELP_HORUS: break;
    case HELP_ARIEL: break;
    case HELP_TLALOC: break;
    case HELP_KALI: break;
    case HELP_CUSTOM: break;
    case HELP_SELECT_WIZARD_PICTURE: break;
    case HELP_SOUND_EFFECTS: break;
    case HELP_BACKGROUND_MUSIC: break;
    case HELP_EVENT_MUSIC: break;
    case HELP_CITY_SPELL_EVENTS: break;
    case HELP_OVERLAND_SPELL_EVENTS: break;
    case HELP_SUMMONING_EVENTS: break;
    case HELP_END_OF_TURN_SUMMARY: break;
    case HELP_AUTOMATIC_ADVICE: break;
    case HELP_RANDOM_EVENTS: break;
    case HELP_AUTOMATIC_COMBAT: break;
    case HELP_REVOLTING_RAIDERS: break;
    case HELP_MONSTERS_GONE_WILD: break;
    case HELP_ENEMY_MOVES: break;
    case HELP_ENEMY_SPELLS: break;
    case HELP_SPELL_BOOK_ORDERING: break;
    case HELP_SPELL_ANIMATIONS: break;
    case HELP_SHOW_NODE_OWNERS: break;
    case HELP_EXPANDING_HELP: break;
    case HELP_ALCHEMY: break;
    case HELP_WARLORD: break;
    case HELP_CHANNELER: break;
    case HELP_ARCHMAGE: break;
    case HELP_ARTIFICER: break;
    case HELP_CONJURER: break;
    case HELP_SAGE_MASTER: break;
    case HELP_MYRRAN: break;
    case HELP_DIVINE_POWER: break;
    case HELP_FAMOUS: break;
    case HELP_RUNEMASTER: break;
    case HELP_CHARISMATIC: break;
    case HELP_CHAOS_MASTERY: break;
    case HELP_NATURE_MASTERY: break;
    case HELP_SORCERY_MASTERY: break;
    case HELP_INFERNAL_POWER: break;
    case HELP_MANA_FOCUSING: break;
    case HELP_NODE_MASTERY: break;
    case HELP_MAGIC_PICKS: break;
    case HELP_play_NEWGAME_OK_BUTTON: break;
    case HELP_SPECIAL2_GUISE: break;
    case HELP_cityscap_TRADE_GOODS: break;
    case HELP_cityscap_HOUSING: break;
    case HELP_cityscap_BARRACKS: break;
    case HELP_cityscap_ARMORY: break;
    case HELP_cityscap_FIGHTERS_GUILD: break;
    case HELP_cityscap_ARMORERS_GUILD: break;
    case HELP_cityscap_WAR_COLLEGE: break;
    case HELP_cityscap_SMITHY: break;
    case HELP_cityscap_STABLES: break;
    case HELP_cityscap_ANIMISTS_GUILD: break;
    case HELP_cityscap_FANTASTIC_STABLE: break;
    case HELP_cityscap_SHIP_WRIGHTS_GUILD: break;
    case HELP_cityscap_SHIPYARD: break;
    case HELP_cityscap_MARITIME_GUILD: break;
    case HELP_cityscap_SAWMILL: break;
    case HELP_cityscap_LIBRARY: break;
    case HELP_cityscap_SAGES_GUILD: break;
    case HELP_cityscap_ORACLE: break;
    case HELP_cityscap_ALCHEMISTS_GUILD: break;
    case HELP_cityscap_UNIVERSITY: break;
    case HELP_cityscap_WIZARDS_GUILD: break;
    case HELP_cityscap_SHRINE: break;
    case HELP_cityscap_TEMPLE: break;
    case HELP_cityscap_PARTHENON: break;
    case HELP_cityscap_CATHEDRAL: break;
    case HELP_cityscap_MARKETPLACE: break;
    case HELP_cityscap_BANK: break;
    case HELP_cityscap_MERCHANTS_GUILD: break;
    case HELP_cityscap_GRANARY: break;
    case HELP_cityscap_FARMERS_MARKET: break;
    case HELP_cityscap_FORESTERS_GUILD: break;
    case HELP_cityscap_BUILDERS_HALL: break;
    case HELP_cityscap_MECHANICIANS_GUILD: break;
    case HELP_cityscap_MINERS_GUILD: break;
    case HELP_CITYSCAP_CITY_WALLS: break;
    case HELP_cityscap_SUMMONING_CIRCLE: break;
    case HELP_cityscap_EARTH_GATE: break;
    case HELP_cityscap_STREAM_OF_LIFE: break;
    case HELP_cityscap_ASTRAL_GATE: break;
    case HELP_cityscap_FORTRESS: break;
    case HELP_cityscap_DARK_RITUALS: break;
    case HELP_cityscap_ALTAR_OF_BATTLE: break;
    case HELP_TREATIES: break;
    case HELP_SCROLL_PAGE_BACK: break;
    case HELP_SCROLL_PAGE_FORWARD: break;
    case HELP_spellscr_CANCEL: break;
    case HELP_EXTRA_MANA_COST: break;
    case HELP_NONE: break;
    case HELP_UNITVIEW_Adamantium_Weapon: break;
    case HELP_TAX_PER_POPULATION: break;
    case HELP_ADVISORS: break;
    case HELP_mirror_FAMOUS: break;
    case HELP_NIGHTSHADE: break;
    case HELP_COMPIX_MANA_LEAK: break;
    case HELP_PLAGUE: break;
    case HELP_POPULATION_BOOM: break;
    case HELP_BLUE_CONJUNCTION: break;
    case HELP_RED_CONJUNCTION: break;
    case HELP_GREEN_CONJUNCTION: break;
    case HELP_BAD_MOON: break;
    case HELP_GOOD_MOON: break;
    case HELP_MANA_SHORT: break;
    case HELP_POPULATION: break;
    case HELP_DEATH_SPELLS: break;
    case HELP_CHAOS_SPELLS: break;
    case HELP_LIFE_SPELLS: break;
    case HELP_NATURE_SPELLS: break;
    case HELP_SORCERY_SPELLS: break;
    case HELP_MANIACAL: break;
    case HELP_RUTHLESS: break;
    case HELP_AGGRESSIVE: break;
    case HELP_CHAOTIC: break;
    case HELP_LAWFUL: break;
    case HELP_PEACEFUL: break;
    case HELP_PRAGMATIST: break;
    case HELP_MILITARIST: break;
    case HELP_THEURGIST: break;
    case HELP_PERFECTIONIST: break;
    case HELP_EXPANSIONIST: break;
    case HELP_WIZARD_PACT: break;
    case HELP_ALLIANCE: break;
    case HELP_NO_REPORT: break;
    case HELP_MOVEMENT_ANIMATIONS: break;
    case HELP_COMPIX_BLUR: break;
    case HELP_HALL_OF_FAME: break;
    case HELP_SPELLS: break;
    case HELP_TOWNSFOLK: break;
    case HELP_BANISHED_WIZARDS: break;
    case HELP_FAME: break;
    case HELP_YEAR: break;
    case HELP_score_SPELL_OF_MASTERY: break;
    case HELP_FINAL_SCORE: break;
    case HELP_RAZE_CITY: break;
    default: std::cout << context << ": Unknown eHelpIndex = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eHeroAbility& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case HEROABILITY_Leadership: break;
    case HEROABILITY_Leadership_X: break;
    case HEROABILITY_2: break;
    case HEROABILITY_Legendary: break;
    case HEROABILITY_Legendary_X: break;
    case HEROABILITY_5: break;
    case HEROABILITY_Blademaster: break;
    case HEROABILITY_Blademaster_X: break;
    case HEROABILITY_8: break;
    case HEROABILITY_Armsmaster: break;
    case HEROABILITY_Armsmaster_X: break;
    case HEROABILITY_11: break;
    case HEROABILITY_Constitution: break;
    case HEROABILITY_Constitution_X: break;
    case HEROABILITY_14: break;
    case HEROABILITY_Might: break;
    case HEROABILITY_Might_X: break;
    case HEROABILITY_17: break;
    case HEROABILITY_Arcane_Power: break;
    case HEROABILITY_Arcane_Power_X: break;
    case HEROABILITY_20: break;
    case HEROABILITY_Sage: break;
    case HEROABILITY_Sage_X: break;
    case HEROABILITY_23: break;
    case HEROABILITY_Prayermaster: break;
    case HEROABILITY_Prayermaster_X: break;
    case HEROABILITY_Agility_X: break;
    case HEROABILITY_Lucky: break;
    case HEROABILITY_Charmed: break;
    case HEROABILITY_Noble: break;
    case HEROABILITY_30: break;
    case HEROABILITY_Agility: break;
    default: std::cout << context << ": Unknown eHeroAbility = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eHero_Level_Status& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case HEROLEVELSTATUS_Level_1: break;
    case HEROLEVELSTATUS_Level_2: break;
    case HEROLEVELSTATUS_Level_3: break;
    case HEROLEVELSTATUS_Level_4: break;
    case HEROLEVELSTATUS_Level_5: break;
    case HEROLEVELSTATUS_Level_6: break;
    case HEROLEVELSTATUS_Level_7: break;
    case HEROLEVELSTATUS_Level_8: break;
    case HEROLEVELSTATUS_Level_9: break;
    case HEROLEVELSTATUS_Dead_Level_1: break;
    case HEROLEVELSTATUS_Dead_Level_2: break;
    case HEROLEVELSTATUS_Dead_Level_3: break;
    case HEROLEVELSTATUS_Dead_Level_4: break;
    case HEROLEVELSTATUS_Dead_Level_5: break;
    case HEROLEVELSTATUS_Dead_Level_6: break;
    case HEROLEVELSTATUS_Dead_Level_7: break;
    case HEROLEVELSTATUS_Dead_Level_8: break;
    case HEROLEVELSTATUS_Dead_Level_9: break;
    case HEROLEVELSTATUS_Active_in_Wizards_army: break;
    default: std::cout << context << ": Unknown eHero_Level_Status = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eHero_TypeCode& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case HEROTYPE_Fighter: break;
    case HEROTYPE_Bow: break;
...
bool validate(const eItemPower& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case ITEMPOWER_Vampiric: break;
    case ITEMPOWER_Guardian_Wind: break;
    case ITEMPOWER_Lightning: break;
    case ITEMPOWER_Cloak_Of_Fear: break;
    case ITEMPOWER_Destruction: break;
    case ITEMPOWER_Wraith_Form: break;
    case ITEMPOWER_Regeneration: break;
    case ITEMPOWER_Pathfinding: break;
    case ITEMPOWER_Water_Walking: break;
    case ITEMPOWER_Resist_Elements: break;
    case ITEMPOWER_Elemental_Armour: break;
    case ITEMPOWER_Doom_equals_Chaos: break;
    case ITEMPOWER_Stoning: break;
    case ITEMPOWER_Endurance: break;
    case ITEMPOWER_Haste: break;
    case ITEMPOWER_Invisibility: break;
    case ITEMPOWER_Death: break;
    case ITEMPOWER_Flight: break;
    case ITEMPOWER_Resist_Magic: break;
    case ITEMPOWER_Magic_Immunity: break;
    case ITEMPOWER_Flaming: break;
    case ITEMPOWER_Holy_Avenger: break;
    case ITEMPOWER_True_Sight: break;
    case ITEMPOWER_Phantasmal: break;
    case ITEMPOWER_Power_Drain: break;
    case ITEMPOWER_Bless: break;
    case ITEMPOWER_Lion_Heart: break;
    case ITEMPOWER_Giant_Strength: break;
    case ITEMPOWER_Planar_Travel: break;
    case ITEMPOWER_Merging: break;
    case ITEMPOWER_Righteousness: break;
    case ITEMPOWER_Invulnerability: break;
    default: std::cout << context << ": Unknown eItemPower = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eItem_Type& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case ITEMTYPE_Sword: break;
    case ITEMTYPE_Mace: break;
    case ITEMTYPE_Axe: break;
    case ITEMTYPE_Bow: break;
    case ITEMTYPE_Staff: break;
    case ITEMTYPE_Wand: break;
    case ITEMTYPE_Various: break;
    case ITEMTYPE_Shield: break;
    case ITEMTYPE_Chain_Mail: break;
    case ITEMTYPE_Plate_Mail: break;
    default: std::cout << context << ": Unknown eItem_Type = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eLand_Size& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case LANDSIZE_Small: break;
    case LANDSIZE_Medium: break;
    case LANDSIZE_Large: break;
    default: std::cout << context << ": Unknown eLand_Size = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eLevel& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case LEVEL_Level_1: break;
    case LEVEL_Level_2: break;
    case LEVEL_Level_3: break;
    case LEVEL_Level_4: break;
    case LEVEL_Level_5: break;
    case LEVEL_Level_6: break;
    case LEVEL_Level_7: break;
    case LEVEL_Level_8: break;
    case LEVEL_Level_9: break;
    default: std::cout << context << ": Unknown eLevel = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eNode_Type& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case NODETYPE_Sorcery: break;
    case NODETYPE_Nature: break;
    case NODETYPE_Chaos: break;
    default: std::cout << context << ": Unknown eNode_Type = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eObjective& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case OBJECTIVE_Pragmatist: break;
    case OBJECTIVE_Militarist: break;
    case OBJECTIVE_Theurgist: break;
    case OBJECTIVE_Perfectionist: break;
    case OBJECTIVE_Expansionist: break;
    default: std::cout << context << ": Unknown eObjective = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eOwner& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case OWNER_None: break;
    case OWNER_YOU: break;
    case OWNER_1: break;
    case OWNER_2: break;
    case OWNER_3: break;
    case OWNER_4: break;
    case OWNER_Neutral: break;
    default: std::cout << context << ": Unknown eOwner = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const ePersonality& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case PERSONALITY_Maniacal: break;
    case PERSONALITY_Ruthless: break;
    case PERSONALITY_Aggressive: break;
    case PERSONALITY_Chaotic: break;
    case PERSONALITY_Lawful: break;
    case PERSONALITY_Peaceful: break;
    default: std::cout << context << ": Unknown ePersonality = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const ePlayer& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case PLAYER_Dismissed_Deceased: break;
    case PLAYER_YOU: break;
    case PLAYER_1: break;
    case PLAYER_2: break;
    case PLAYER_3: break;
    case PLAYER_4: break;
    case PLAYER_NEUTRAL: break;
    default: std::cout << context << ": Unknown ePlayer = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const ePortrait& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case PORTRAIT_Merlin: break;
    case PORTRAIT_Raven: break;
    case PORTRAIT_Sharee: break;
    case PORTRAIT_Lo_Pan: break;
    case PORTRAIT_Jafar: break;
    case PORTRAIT_Oberic: break;
    case PORTRAIT_Rjak: break;
    case PORTRAIT_Sssra: break;
    case PORTRAIT_Tauron: break;
    case PORTRAIT_Freya: break;
    case PORTRAIT_Horus: break;
    case PORTRAIT_Ariel: break;
    case PORTRAIT_Tlaloc: break;
    case PORTRAIT_Kali: break;
    case PORTRAIT_Custom: break;
    default: std::cout << context << ": Unknown ePortrait = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eProducing& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case PRODUCING_Computer: break;
    case PRODUCING_None: break;
    case PRODUCING_Trade_Goods: break;
    case PRODUCING_Housing: break;
    case PRODUCING_Barracks: break;
    case PRODUCING_Armory: break;
    case PRODUCING_Fighters_Guild: break;
    case PRODUCING_Armorers_Guild: break;
    case PRODUCING_War_College: break;
    case PRODUCING_Smithy: break;
    case PRODUCING_Stable: break;
    case PRODUCING_Animists_Guild: break;
    case PRODUCING_Fantastic_Stable: break;
    case PRODUCING_Shipwright_Guild: break;
    case PRODUCING_Ship_Yard: break;
    case PRODUCING_Maritime_Guild: break;
    case PRODUCING_Sawmill: break;
    case PRODUCING_Library: break;
    case PRODUCING_Sages_Guild: break;
    case PRODUCING_Oracle: break;
    case PRODUCING_Alchemist_Guild: break;
    case PRODUCING_University: break;
    case PRODUCING_Wizards_Guild: break;
    case PRODUCING_Shrine: break;
    case PRODUCING_Temple: break;
    case PRODUCING_Parthenon: break;
    case PRODUCING_Cathedral: break;
    case PRODUCING_Marketplace: break;
    case PRODUCING_Bank: break;
    case PRODUCING_Merchants_Guild: break;
    case PRODUCING_Granary: break;
    case PRODUCING_Farmers_Market: break;
    case PRODUCING_Foresters_Guild: break;
    case PRODUCING_Builders_Hall: break;
    case PRODUCING_Mechanicians_Guild: break;
    case PRODUCING_Miners_Guild: break;
    case PRODUCING_City_Walls: break;
    case PRODUCING_Trireme: break;
    case PRODUCING_Galley: break;
    case PRODUCING_Catapult: break;
    case PRODUCING_Warship: break;
    case PRODUCING_Barbarian_Spearmen: break;
    case PRODUCING_Barbarian_Swordsmen: break;
    case PRODUCING_Barbarian_Bowmen: break;
    case PRODUCING_Barbarian_Cavalry: break;
    case PRODUCING_Barbarian_Shaman: break;
    case PRODUCING_Barbarian_Settlers: break;
    case PRODUCING_Barbarian_Berserkers: break;
    case PRODUCING_Beastmen_Spearmen: break;
    case PRODUCING_Beastmen_Swordsmen: break;
    case PRODUCING_Beastmen_Halberdiers: break;
    case PRODUCING_Beastmen_Bowmen: break;
    case PRODUCING_Beastmen_Priests: break;
    case PRODUCING_Beastmen_Magicians: break;
    case PRODUCING_Beastmen_Engineers: break;
    case PRODUCING_Beastmen_Settlers: break;
    case PRODUCING_Beastmen_Centaurs: break;
    case PRODUCING_Beastmen_Manticores: break;
    case PRODUCING_Beastmen_Minotaurs: break;
    case PRODUCING_Dark_Elf_Spearmen: break;
    case PRODUCING_Dark_Elf_Swordsmen: break;
    case PRODUCING_Dark_Elf_Halberdiers: break;
    case PRODUCING_Dark_Elf_Cavalry: break;
    case PRODUCING_Dark_Elf_Priests: break;
    case PRODUCING_Dark_Elf_Settlers: break;
    case PRODUCING_Dark_Elf_Nightblades: break;
    case PRODUCING_Dark_Elf_Warlocks: break;
    case PRODUCING_Dark_Elf_Nightmares: break;
    case PRODUCING_Draconian_Spearmen: break;
    case PRODUCING_Draconian_Swordsmen: break;
    case PRODUCING_Draconian_Halberdiers: break;
    case PRODUCING_Draconian_Bowmen: break;
    case PRODUCING_Draconian_Shaman: break;
    case PRODUCING_Draconian_Magicians: break;
    case PRODUCING_Draconian_Engineers: break;
    case PRODUCING_Draconian_Settlers: break;
    case PRODUCING_Draconian_Doom_Drakes: break;
    case PRODUCING_Draconian_Air_Ship: break;
    case PRODUCING_Dwarven_Swordsmen: break;
    case PRODUCING_Dwarven_Halberdiers: break;
    case PRODUCING_Dwarven_Engineers: break;
    case PRODUCING_Dwarven_Hammerhands: break;
    case PRODUCING_Dwarven_Steam_Cannon: break;
    case PRODUCING_Dwarven_Golem: break;
    case PRODUCING_Dwarven_Settlers: break;
    case PRODUCING_Gnoll_Spearmen: break;
    case PRODUCING_Gnoll_Swordsmen: break;
    case PRODUCING_Gnoll_Halberdiers: break;
    case PRODUCING_Gnoll_Bowmen: break;
    case PRODUCING_Gnoll_Settlers: break;
    case PRODUCING_Gnoll_Wolf_Riders: break;
    case PRODUCING_Halfling_Spearmen: break;
    case PRODUCING_Halfling_Swordsmen: break;
    case PRODUCING_Halfling_Bowmen: break;
    case PRODUCING_Halfling_Shaman: break;
    case PRODUCING_Halfling_Settlers: break;
    case PRODUCING_Halfling_Slingers: break;
    case PRODUCING_High_Elf_Spearmen: break;
    case PRODUCING_High_Elf_Swordsmen: break;
    case PRODUCING_High_Elf_Halberdiers: break;
    case PRODUCING_High_Elf_Cavalry: break;
    case PRODUCING_High_Elf_Magicians: break;
    case PRODUCING_High_Elf_Settlers: break;
    case PRODUCING_High_Elf_Longbowmen: break;
    case PRODUCING_High_Elf_Elven_Lords: break;
    case PRODUCING_High_Elf_Pegasai: break;
    case PRODUCING_High_Men_Spearmen: break;
    case PRODUCING_High_Men_Swordsmen: break;
    case PRODUCING_High_Men_Bowmen: break;
    case PRODUCING_High_Men_Cavalry: break;
    case PRODUCING_High_Men_Priests: break;
    case PRODUCING_High_Men_Magicians: break;
    case PRODUCING_High_Men_Engineers: break;
    case PRODUCING_High_Men_Settlers: break;
    case PRODUCING_High_Men_Pikemen: break;
    case PRODUCING_High_Men_Paladins: break;
    case PRODUCING_Klackon_Spearmen: break;
    case PRODUCING_Klackon_Swordsmen: break;
    case PRODUCING_Klackon_Halberdiers: break;
    case PRODUCING_Klackon_Engineers: break;
    case PRODUCING_Klackon_Settlers: break;
    case PRODUCING_Klackon_Stag_Beetle: break;
    case PRODUCING_Lizardman_Spearmen: break;
    case PRODUCING_Lizardman_Swordsmen: break;
    case PRODUCING_Lizardman_Halberdiers: break;
    case PRODUCING_Lizardman_Javelineers: break;
    case PRODUCING_Lizardman_Shaman: break;
    case PRODUCING_Lizardman_Settlers: break;
    case PRODUCING_Lizardman_Dragon_Turtle: break;
    case PRODUCING_Nomad_Spearmen: break;
    case PRODUCING_Nomad_Swordsmen: break;
    case PRODUCING_Nomad_Bowmen: break;
    case PRODUCING_Nomad_Priests: break;
    case PRODUCING_Nomad_Magicians: break;
    case PRODUCING_Nomad_Settlers: break;
    case PRODUCING_Nomad_Horsebowmen: break;
    case PRODUCING_Nomad_Pikemen: break;
    case PRODUCING_Nomad_Rangers: break;
    case PRODUCING_Nomad_Griffins: break;
    case PRODUCING_Orc_Spearmen: break;
    case PRODUCING_Orc_Swordsmen: break;
    case PRODUCING_Orc_Halberdiers: break;
    case PRODUCING_Orc_Bowmen: break;
    case PRODUCING_Orc_Cavalry: break;
    case PRODUCING_Orc_Shaman: break;
    case PRODUCING_Orc_Magicians: break;
    case PRODUCING_Orc_Engineers: break;
    case PRODUCING_Orc_Settlers: break;
    case PRODUCING_Orc_Wyvern_Riders: break;
    case PRODUCING_Troll_Spearmen: break;
    case PRODUCING_Troll_Swordsmen: break;
    case PRODUCING_Troll_Halberdiers: break;
    case PRODUCING_Troll_Shaman: break;
    case PRODUCING_Troll_Settlers: break;
    case PRODUCING_Troll_War_Trolls: break;
    case PRODUCING_Troll_War_Mammoths: break;
    default: std::cout << context << ": Unknown eProducing = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eRace& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case RACE_Barbarian: break;
    case RACE_Beastmen: break;
    case RACE_Dark_Elf: break;
    case RACE_Draconian: break;
    case RACE_Dwarven: break;
    case RACE_Gnoll: break;
    case RACE_Halfling: break;
    case RACE_High_Elf: break;
    case RACE_High_Men: break;
    case RACE_Klackon: break;
    case RACE_Lizardman: break;
    case RACE_Nomad: break;
    case RACE_Orc: break;
    case RACE_Troll: break;
    case RACE_Generic_ship_or_catapult: break;
    case RACE_Arcane: break;
    case RACE_Nature: break;
    case RACE_Sorcery: break;
    case RACE_Chaos: break;
    case RACE_Life: break;
    case RACE_Death: break;
    default: std::cout << context << ": Unknown eRace = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eRanged_Type& rhs, const std::string& context)
{
    ...
    case RANGED_Chaos_Magic3_Demon: break;
    case RANGED_Nature_Magic1_Wind_Mage: break;
    case RANGED_Nature_Magic2_Shamans: break;
    case RANGED_Chaos_Magic4_Dark_Elves: break;
    case RANGED_Nature_Magic3_Sprites: break;
    case RANGED_Nature_Magic4_Druid: break;
    case RANGED_Thrown_Weapons: break;
    case RANGED_Fire_Breath: break;
    case RANGED_Lightning_Breath: break;
    case RANGED_Stoning_Gaze: break;
    case RANGED_Multiple_Gaze: break;
    case RANGED_Death_Gaze: break;
    default: std::cout << context << ": Unknown eRanged_Type = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eRarity& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case RARITY_Common: break;
    case RARITY_Uncommon: break;
    case RARITY_Rare: break;
    case RARITY_Very_Rare: break;
    default: std::cout << context << ": Unknown eRarity = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eRealm_Type& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case REALM_Nature: break;
    case REALM_Sorcery: break;
    case REALM_Chaos: break;
    case REALM_Life: break;
    case REALM_Death: break;
    case REALM_Arcane: break;
    default: std::cout << context << ": Unknown eRealm_Type = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eReward_Specials& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case REWARD_No_specials: break;
    case REWARD_Common_Spell: break;
    case REWARD_Uncommon_Spell: break;
    case REWARD_Rare_Spell: break;
    case REWARD_Very_Rare_Spell: break;
    case REWARD_1_Spellbook_or_Skill: break;
    case REWARD_2_Spellbooks_or_Skills: break;
    default: std::cout << context << ": Unknown eReward_Specials = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eSkill& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case SKILL_Alchemy: break;
    case SKILL_Warlord: break;
    case SKILL_Chaos_Master: break;
    case SKILL_Nature_Master: break;
    case SKILL_Sorcery_Master: break;
    case SKILL_Infernal_Power: break;
    case SKILL_Divine_Power: break;
    case SKILL_Sage_Master: break;
    case SKILL_Channeller: break;
    case SKILL_Myrran: break;
    case SKILL_Archmage: break;
    case SKILL_Mana_Focusing: break;
    case SKILL_Node_Mastery: break;
    case SKILL_Famous: break;
    case SKILL_Runemaster: break;
    case SKILL_Conjurer: break;
    case SKILL_Charismatic: break;
    case SKILL_Artificer: break;
    default: std::cout << context << ": Unknown eSkill = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eSkill16& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case SKILL16_None: break;
    case SKILL16_Alchemy: break;
    case SKILL16_Warlord: break;
    case SKILL16_Chaos_Master: break;
    case SKILL16_Nature_Master: break;
    case SKILL16_Sorcery_Master: break;
    case SKILL16_Infernal_Power: break;
    case SKILL16_Divine_Power: break;
    case SKILL16_Sage_Master: break;
    case SKILL16_Channeller: break;
    case SKILL16_Myrran: break;
    case SKILL16_Archmage: break;
    case SKILL16_Mana_Focusing: break;
    case SKILL16_Node_Mastery: break;
    case SKILL16_Famous: break;
    case SKILL16_Runemaster: break;
    case SKILL16_Conjurer: break;
    case SKILL16_Charismatic: break;
    case SKILL16_Artificer: break;
    default: std::cout << context << ": Unknown eSkill16 = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eSlot_Type16& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case SLOT16_Sword: break;
    case SLOT16_Bow: break;
    case SLOT16_Sword_Staff_Wand: break;
    case SLOT16_Staff_Wand: break;
    case SLOT16_Armor_Shield: break;
    case SLOT16_Amulet: break;
    default: std::cout << context << ": Unknown eSlot_Type16 = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eSlot_Type8& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case SLOT8_Sword: break;
    case SLOT8_Bow: break;
    case SLOT8_Sword_Staff_Wand: break;
    case SLOT8_Staff_Wand: break;
    case SLOT8_Armor_Shield: break;
    case SLOT8_Amulet: break;
    default: std::cout << context << ": Unknown eSlot_Type8 = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eSpell& rhs, const std::string& context)
{
    ...
    case SPELL_Earth_to_Mud: break;
    case SPELL_Resist_Elements: break;
    case SPELL_Wall_of_Stone: break;
    case SPELL_Giant_Strength: break;
    case SPELL_Web: break;
    case SPELL_War_Bears: break;
    case SPELL_Stone_Skin: break;
    case SPELL_Water_Walking: break;
    case SPELL_Sprites: break;
    case SPELL_Earth_Lore: break;
    case SPELL_Cracks_Call: break;
    case SPELL_Natures_Eye: break;
    case SPELL_Ice_Bolt: break;
    case SPELL_Giant_Spiders: break;
    case SPELL_Change_Terrain: break;
    case SPELL_Path_Finding: break;
    case SPELL_Cockatrices: break;
    case SPELL_Transmute: break;
    case SPELL_Natures_Cures: break;
    case SPELL_Basilisk: break;
    case SPELL_Elemental_Armor: break;
    case SPELL_Petrify: break;
    case SPELL_Stone_Giant: break;
    case SPELL_Iron_Skin: break;
    case SPELL_Ice_Storm: break;
    case SPELL_Earthquake: break;
    case SPELL_Gorgons: break;
    case SPELL_Move_Fortress: break;
    case SPELL_Gaias_Blessing: break;
    case SPELL_Earth_Elemental: break;
    case SPELL_Regeneration: break;
    case SPELL_Behemoth: break;
    case SPELL_Entangle: break;
    case SPELL_Nature_Awareness: break;
    case SPELL_Call_Lightning: break;
    case SPELL_Colossus: break;
    case SPELL_Earth_Gate: break;
    case SPELL_Herb_Mastery: break;
    case SPELL_Great_Wyrm: break;
    case SPELL_Natures_Wrath: break;
    case SPELL_Resist_Magic: break;
    case SPELL_Dispel_Magic_True: break;
    case SPELL_Floating_Island: break;
    case SPELL_Guardian_Wind: break;
    case SPELL_Phantom_Warriors: break;
    case SPELL_Confusion: break;
    case SPELL_Word_of_Recall: break;
    case SPELL_Counter_Magic: break;
    case SPELL_Nagas: break;
    case SPELL_Psionic_Blast: break;
    case SPELL_Blur: break;
    case SPELL_Disenchant_True: break;
    case SPELL_Vertigo: break;
    case SPELL_Spell_Lock: break;
    case SPELL_Enchant_Road: break;
    case SPELL_Flight: break;
    case SPELL_Wind_Mastery: break;
    case SPELL_Spell_Blast: break;
    case SPELL_Aura_of_Majesty: break;
    case SPELL_Phantom_Beast: break;
    case SPELL_Disjunction_True: break;
    case SPELL_Invisibility: break;
    case SPELL_Wind_Walking: break;
    case SPELL_Banish: break;
    case SPELL_Storm_Giant: break;
    case SPELL_Air_Elemental: break;
    case SPELL_Mind_Storm: break;
    case SPELL_Stasis: break;
    case SPELL_Magic_Immunity: break;
    case SPELL_Haste: break;
    case SPELL_Djinn: break;
    case SPELL_Spell_Ward: break;
    case SPELL_Creature_Binding: break;
    case SPELL_Mass_Invisibility: break;
    case SPELL_Great_Unsummoning: break;
    case SPELL_Spell_Binding: break;
    case SPELL_Flying_Fortress: break;
    case SPELL_Sky_Drake: break;
    case SPELL_Suppress_Magic: break;
    case SPELL_Time_Stop: break;
    case SPELL_Warp_Wood: break;
    case SPELL_Disrupt: break;
    case SPELL_Fire_Bolt: break;
    case SPELL_Hell_Hounds: break;
    case SPELL_Corruption: break;
    case SPELL_Eldritch_Weapon: break;
    case SPELL_Wall_of_Fire: break;
    case SPELL_Shatter: break;
    case SPELL_Warp_Creature: break;
    case SPELL_Fire_Elemental: break;
    case SPELL_Lightning_Bolt: break;
    case SPELL_Fire_Giant: break;
    case SPELL_Chaos_Channels: break;
    case SPELL_Flame_Blade: break;
    case SPELL_Gargoyles: break;
    case SPELL_Fireball: break;
    case SPELL_Doombat: break;
    case SPELL_Raise_Volcano: break;
    case SPELL_Immolation: break;
    case SPELL_Chimeras: break;
    case SPELL_Warp_Lightning: break;
    case SPELL_Metal_Fires: break;
    case SPELL_Chaos_Spawn: break;
    case SPELL_Doom_Bolt: break;
    case SPELL_Magic_Vortex: break;
    case SPELL_Efreet: break;
    case SPELL_Fire_Storm: break;
    case SPELL_Warp_Reality: break;
    case SPELL_Flame_Strike: break;
    case SPELL_Chaos_Rift: break;
    case SPELL_Hydra: break;
    case SPELL_Disintegrate: break;
    case SPELL_Meteor_Storm: break;
    case SPELL_Great_Wasting: break;
    case SPELL_Call_Chaos: break;
    case SPELL_Chaos_Surge: break;
    case SPELL_Doom_Mastery: break;
    case SPELL_Great_Drake: break;
    case SPELL_Call_The_Void: break;
    case SPELL_Armageddon: break;
    case SPELL_Bless: break;
    case SPELL_Star_Fires: break;
    case SPELL_Endurance: break;
    case SPELL_Holy_Weapon: break;
    case SPELL_Healing: break;
    case SPELL_Holy_Armor: break;
    case SPELL_Just_Cause: break;
    case SPELL_True_Light: break;
    case SPELL_Guardian_Spirit: break;
    case SPELL_Heroism: break;
    case SPELL_True_Sight: break;
    case SPELL_Plane_Shift: break;
    case SPELL_Resurrection: break;
    case SPELL_Dispel_Evil: break;
    case SPELL_Planar_Seal: break;
    case SPELL_Unicorns: break;
    case SPELL_Raise_Dead: break;
    case SPELL_Planar_Travel: break;
    case SPELL_Heavenly_Light: break;
    case SPELL_Prayer: break;
    case SPELL_Lionheart: break;
    case SPELL_Incarnation: break;
    case SPELL_Invulnerability: break;
    case SPELL_Righteousness: break;
    case SPELL_Prosperity: break;
    case SPELL_Altar_of_Battle: break;
    case SPELL_Angel: break;
    case SPELL_Stream_of_Life: break;
    case SPELL_Mass_Healing: break;
    case SPELL_Holy_Word: break;
    case SPELL_High_Prayer: break;
    case SPELL_Inspirations: break;
    case SPELL_Astral_Gate: break;
    case SPELL_Holy_Arms: break;
    case SPELL_Consecration: break;
    case SPELL_Life_Force: break;
    case SPELL_Tranquility: break;
    case SPELL_Crusade: break;
    case SPELL_Arch_Angel: break;
    case SPELL_Charm_of_Life: break;
    case SPELL_Skeletons: break;
    case SPELL_Weakness: break;
    case SPELL_Dark_Rituals: break;
    case SPELL_Cloak_of_Fear: break;
    case SPELL_Black_Sleep: break;
    case SPELL_Ghouls: break;
    case SPELL_Life_Drain: break;
    case SPELL_Terror: break;
    case SPELL_Darkness: break;
    case SPELL_Mana_Leak: break;
    case SPELL_Drain_Power: break;
    case SPELL_Possession: break;
    case SPELL_Lycantrophy: break;
    case SPELL_Black_Prayer: break;
    case SPELL_Black_Channels: break;
    case SPELL_Night_Stalker: break;
    case SPELL_Subversion: break;
    case SPELL_Wall_of_Darkness: break;
    case SPELL_Berserk: break;
    case SPELL_Shadow_Demons: break;
    case SPELL_Wraith_Form: break;
    case SPELL_Wrack: break;
    case SPELL_Evil_Presence: break;
    case SPELL_Wraiths: break;
    case SPELL_Cloud_Of_Shadow: break;
    case SPELL_Warp_Node: break;
    case SPELL_Black_Wind: break;
    case SPELL_Zombie_Mastery: break;
    case SPELL_Famine: break;
    case SPELL_Cursed_Lands: break;
    case SPELL_Cruel_Unminding: break;
    case SPELL_Word_of_Death: break;
    case SPELL_Death_Knights: break;
    case SPELL_Death_Spell: break;
    case SPELL_Animate_dead: break;
    case SPELL_Pestilence: break;
    case SPELL_Eternal_Night: break;
    case SPELL_Evil_Omens: break;
    case SPELL_Death_Wish: break;
    case SPELL_Demon_Lord: break;
    case SPELL_Magic_Spirit: break;
    case SPELL_Dispel_Magic: break;
    case SPELL_Summoning_Circle: break;
    case SPELL_Disenchant_Area: break;
    case SPELL_Recall_Hero: break;
    case SPELL_Detect_Magic: break;
    case SPELL_Enchant_Item: break;
    case SPELL_Summon_Hero: break;
    case SPELL_Awareness: break;
    case SPELL_Disjunction: break;
    case SPELL_Create_Artifact: break;
    case SPELL_Summon_Champion: break;
    case SPELL_Spell_Of_Mastery: break;
    case SPELL_Spell_Of_Return: break;
    default: std::cout << context << ": Unknown eSpell = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eSpell16& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case SPELL16_None: break;
    case SPELL16_Earth_to_Mud: break;
    case SPELL16_Resist_Elements: break;
    case SPELL16_Wall_of_Stone: break;
    case SPELL16_Giant_Strength: break;
    case SPELL16_Web: break;
    case SPELL16_War_Bears: break;
    case SPELL16_Stone_Skin: break;
    case SPELL16_Water_Walking: break;
    case SPELL16_Sprites: break;
    case SPELL16_Earth_Lore: break;
    case SPELL16_Cracks_Call: break;
    case SPELL16_Natures_Eye: break;
    case SPELL16_Ice_Bolt: break;
    case SPELL16_Giant_Spiders: break;
    case SPELL16_Change_Terrain: break;
    case SPELL16_Path_Finding: break;
    case SPELL16_Cockatrices: break;
    case SPELL16_Transmute: break;
    case SPELL16_Natures_Cures: break;
    case SPELL16_Basilisk: break;
    case SPELL16_Elemental_Armor: break;
    case SPELL16_Petrify: break;
    case SPELL16_Stone_Giant: break;
    case SPELL16_Iron_Skin: break;
    case SPELL16_Ice_Storm: break;
    case SPELL16_Earthquake: break;
    case SPELL16_Gorgons: break;
    case SPELL16_Move_Fortress: break;
    case SPELL16_Gaias_Blessing: break;
    case SPELL16_Earth_Elemental: break;
    case SPELL16_Regeneration: break;
    case SPELL16_Behemoth: break;
    case SPELL16_Entangle: break;
    case SPELL16_Nature_Awareness: break;
    case SPELL16_Call_Lightning: break;
    case SPELL16_Colossus: break;
    case SPELL16_Earth_Gate: break;
    case SPELL16_Herb_Mastery: break;
    case SPELL16_Great_Wyrm: break;
    case SPELL16_Natures_Wrath: break;
    case SPELL16_Resist_Magic: break;
    case SPELL16_Dispel_Magic_True: break;
    case SPELL16_Floating_Island: break;
    case SPELL16_Guardian_Wind: break;
    case SPELL16_Phantom_Warriors: break;
    case SPELL16_Confusion: break;
    case SPELL16_Word_of_Recall: break;
    case SPELL16_Counter_Magic: break;
    case SPELL16_Nagas: break;
    case SPELL16_Psionic_Blast: break;
    case SPELL16_Blur: break;
    case SPELL16_Disenchant_True: break;
    case SPELL16_Vertigo: break;
    case SPELL16_Spell_Lock: break;
    case SPELL16_Enchant_Road: break;
    case SPELL16_Flight: break;
    case SPELL16_Wind_Mastery: break;
    case SPELL16_Spell_Blast: break;
    case SPELL16_Aura_of_Majesty: break;
    case SPELL16_Phantom_Beast: break;
    case SPELL16_Disjunction_True: break;
    case SPELL16_Invisibility: break;
    case SPELL16_Wind_Walking: break;
    case SPELL16_Banish: break;
    case SPELL16_Storm_Giant: break;
    case SPELL16_Air_Elemental: break;
    case SPELL16_Mind_Storm: break;
    case SPELL16_Stasis: break;
    case SPELL16_Magic_Immunity: break;
    case SPELL16_Haste: break;
    case SPELL16_Djinn: break;
    case SPELL16_Spell_Ward: break;
    case SPELL16_Creature_Binding: break;
    case SPELL16_Mass_Invisibility: break;
    case SPELL16_Great_Unsummoning: break;
    case SPELL16_Spell_Binding: break;
    case SPELL16_Flying_Fortress: break;
    case SPELL16_Sky_Drake: break;
    case SPELL16_Suppress_Magic: break;
    case SPELL16_Time_Stop: break;
    case SPELL16_Warp_Wood: break;
    case SPELL16_Disrupt: break;
    case SPELL16_Fire_Bolt: break;
    case SPELL16_Hell_Hounds: break;
    case SPELL16_Corruption: break;
    case SPELL16_Eldritch_Weapon: break;
    case SPELL16_Wall_of_Fire: break;
    case SPELL16_Shatter: break;
    case SPELL16_Warp_Creature: break;
    case SPELL16_Fire_Elemental: break;
    case SPELL16_Lightning_Bolt: break;
    case SPELL16_Fire_Giant: break;
    case SPELL16_Chaos_Channels: break;
    case SPELL16_Flame_Blade: break;
    case SPELL16_Gargoyles: break;
    case SPELL16_Fireball: break;
    case SPELL16_Doombat: break;
    case SPELL16_Raise_Volcano: break;
    case SPELL16_Immolation: break;
    case SPELL16_Chimeras: break;
    case SPELL16_Warp_Lightning: break;
    case SPELL16_Metal_Fires: break;
    case SPELL16_Chaos_Spawn: break;
    case SPELL16_Doom_Bolt: break;
    case SPELL16_Magic_Vortex: break;
    case SPELL16_Efreet: break;
    case SPELL16_Fire_Storm: break;
    case SPELL16_Warp_Reality: break;
    case SPELL16_Flame_Strike: break;
    case SPELL16_Chaos_Rift: break;
    case SPELL16_Hydra: break;
    case SPELL16_Disintegrate: break;
    case SPELL16_Meteor_Storm: break;
    case SPELL16_Great_Wasting: break;
    case SPELL16_Call_Chaos: break;
    case SPELL16_Chaos_Surge: break;
    case SPELL16_Doom_Mastery: break;
    case SPELL16_Great_Drake: break;
    case SPELL16_Call_The_Void: break;
    case SPELL16_Armageddon: break;
    case SPELL16_Bless: break;
    case SPELL16_Star_Fires: break;
    case SPELL16_Endurance: break;
    case SPELL16_Holy_Weapon: break;
    case SPELL16_Healing: break;
    case SPELL16_Holy_Armor: break;
    case SPELL16_Just_Cause: break;
    case SPELL16_True_Light: break;
    case SPELL16_Guardian_Spirit: break;
    case SPELL16_Heroism: break;
    case SPELL16_True_Sight: break;
    case SPELL16_Plane_Shift: break;
    case SPELL16_Resurrection: break;
    case SPELL16_Dispel_Evil: break;
    case SPELL16_Planar_Seal: break;
    case SPELL16_Unicorns: break;
    case SPELL16_Raise_Dead: break;
    case SPELL16_Planar_Travel: break;
    case SPELL16_Heavenly_Light: break;
    case SPELL16_Prayer: break;
    case SPELL16_Lionheart: break;
    case SPELL16_Incarnation: break;
    case SPELL16_Invulnerability: break;
    case SPELL16_Righteousness: break;
    case SPELL16_Prosperity: break;
    case SPELL16_Altar_of_Battle: break;
    case SPELL16_Angel: break;
    case SPELL16_Stream_of_Life: break;
    case SPELL16_Mass_Healing: break;
    case SPELL16_Holy_Word: break;
    case SPELL16_High_Prayer: break;
    case SPELL16_Inspirations: break;
    case SPELL16_Astral_Gate: break;
    case SPELL16_Holy_Arms: break;
    case SPELL16_Consecration: break;
    case SPELL16_Life_Force: break;
    case SPELL16_Tranquility: break;
    case SPELL16_Crusade: break;
    case SPELL16_Arch_Angel: break;
    case SPELL16_Charm_of_Life: break;
    case SPELL16_Skeletons: break;
    case SPELL16_Weakness: break;
    case SPELL16_Dark_Rituals: break;
    case SPELL16_Cloak_of_Fear: break;
    case SPELL16_Black_Sleep: break;
    case SPELL16_Ghouls: break;
    case SPELL16_Life_Drain: break;
    case SPELL16_Terror: break;
    case SPELL16_Darkness: break;
    case SPELL16_Mana_Leak: break;
    case SPELL16_Drain_Power: break;
    case SPELL16_Possession: break;
    case SPELL16_Lycantrophy: break;
    case SPELL16_Black_Prayer: break;
    case SPELL16_Black_Channels: break;
    case SPELL16_Night_Stalker: break;
    case SPELL16_Subversion: break;
    case SPELL16_Wall_of_Darkness: break;
    case SPELL16_Berserk: break;
    case SPELL16_Shadow_Demons: break;
    case SPELL16_Wraith_Form: break;
    case SPELL16_Wrack: break;
    case SPELL16_Evil_Presence: break;
    case SPELL16_Wraiths: break;
    case SPELL16_Cloud_Of_Shadow: break;
    case SPELL16_Warp_Node: break;
    case SPELL16_Black_Wind: break;
    case SPELL16_Zombie_Mastery: break;
    case SPELL16_Famine: break;
    case SPELL16_Cursed_Lands: break;
    case SPELL16_Cruel_Unminding: break;
    case SPELL16_Word_of_Death: break;
    case SPELL16_Death_Knights: break;
    case SPELL16_Death_Spell: break;
    case SPELL16_Animate_dead: break;
    case SPELL16_Pestilence: break;
    case SPELL16_Eternal_Night: break;
    case SPELL16_Evil_Omens: break;
    case SPELL16_Death_Wish: break;
    case SPELL16_Demon_Lord: break;
    case SPELL16_Magic_Spirit: break;
    case SPELL16_Dispel_Magic: break;
    case SPELL16_Summoning_Circle: break;
    case SPELL16_Disenchant_Area: break;
    case SPELL16_Recall_Hero: break;
    case SPELL16_Detect_Magic: break;
    case SPELL16_Enchant_Item: break;
    case SPELL16_Summon_Hero: break;
    case SPELL16_Awareness: break;
    case SPELL16_Disjunction: break;
    case SPELL16_Create_Artifact: break;
    case SPELL16_Summon_Champion: break;
    case SPELL16_Spell_Of_Mastery: break;
    case SPELL16_Spell_Of_Return: break;
    default: std::cout << context << ": Unknown eSpell16 = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eSpellKnown& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case SPELLKNOWN_unknown: break;
    case SPELLKNOWN_knowable: break;
    case SPELLKNOWN_currently_known: break;
    case SPELLKNOWN_researchable: break;
    default: std::cout << context << ": Unknown eSpellKnown = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eSpellKnown16& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case SPELLKNOWN16_unknown: break;
    case SPELLKNOWN16_knowable: break;
    case SPELLKNOWN16_currently_known: break;
    case SPELLKNOWN16_researchable: break;
    default: std::cout << context << ": Unknown eSpellKnown16 = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eSpell_Type& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case SPELLTYPE_Special_Spells: break;
    case SPELLTYPE_Summoning: break;
    case SPELLTYPE_Enchantment: break;
    case SPELLTYPE_City_Spells: break;
    case SPELLTYPE_Unit_Spells: break;
    case SPELLTYPE_Combat_Spells: break;
    default: std::cout << context << ": Unknown eSpell_Type = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eTax_Rate& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case TAX_00_gold_00_unrest: break;
    case TAX_05_gold_10_unrest: break;
    case TAX_10_gold_20_unrest: break;
    case TAX_15_gold_30_unrest: break;
    case TAX_20_gold_45_unrest: break;
    case TAX_25_gold_60_unrest: break;
    case TAX_30_gold_75_unrest: break;
    default: std::cout << context << ": Unknown eTax_Rate = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eTerrainBonusDeposit& rhs, const std::string& context)
{
    ...
    case DEPOSIT_Unk10: break;
    case DEPOSIT_Unk20: break;
...
bool validate(const eTerrainCategory& rhs, const std::string& context)
{
    bool ok = true;
    switch (rhs)
    {
    case TERRAINCATEGORY_Ocean: break;
    case TERRAINCATEGORY_Grasslands: break;
    case TERRAINCATEGORY_Forest: break;
    case TERRAINCATEGORY_Mountain: break;
    case TERRAINCATEGORY_Desert: break;
    case TERRAINCATEGORY_Swamp: break;
    case TERRAINCATEGORY_Tundra: break;
    case TERRAINCATEGORY_Shore: break;
    case TERRAINCATEGORY_RiverMouth: break;
    case TERRAINCATEGORY_Hills: break;
    case TERRAINCATEGORY_Plains: break;
    case TERRAINCATEGORY_River: break;
    case TERRAINCATEGORY_Volcano: break;
    default: std::cout << context << ": Unknown eTerrainCategory = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}

bool validate(const eTerrainChange& rhs, const std::string& context)
{
    bool ok = true;
    switch (rhs)
    {
    case TERRAINCHANGE_Volcano_you: break;
    case TERRAINCHANGE_Volcano_player1: break;
    case TERRAINCHANGE_Volcano_player3: break;
    case TERRAINCHANGE_Road: break;
    case TERRAINCHANGE_Enchanted_Road: break;
    case TERRAINCHANGE_Corruption: break;
    case TERRAINCHANGE_Unk40: break;
    case TERRAINCHANGE_NoRoad80: break;
    default: std::cout << context << ": Unknown eTerrainChange = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eTower_Node_Lair_Status& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case LAIRSTATUS_popped: break;
    case LAIRSTATUS_intact: break;
    default: std::cout << context << ": Unknown eTower_Node_Lair_Status = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eTower_Node_Lair_Type& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case LAIRTYPE_Tower: break;
    case LAIRTYPE_Chaos_node: break;
    case LAIRTYPE_Nature_node: break;
    case LAIRTYPE_Sorcery_node: break;
    case LAIRTYPE_Mysterious_cave: break;
    case LAIRTYPE_Dungeon: break;
    case LAIRTYPE_Ancient_temple: break;
    case LAIRTYPE_Abandoned_keep: break;
    case LAIRTYPE_Monster_lair: break;
    case LAIRTYPE_Ruins: break;
    case LAIRTYPE_Fallen_temple: break;
    default: std::cout << context << ": Unknown eTower_Node_Lair_Type = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eUnitAbility& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case eUnitAbility_NONE: break;
    case UNITABILITY_Cavalry: break;
    case UNITABILITY_Sailing: break;
    case UNITABILITY_Swimming: break;
    case UNITABILITY_Flying: break;
    case UNITABILITY_Teleporting: break;
    case UNITABILITY_Forester: break;
    case UNITABILITY_Mountaineer: break;
    case UNITABILITY_Merging: break;
    case UNITABILITY_Fire_Immunity: break;
    case UNITABILITY_Stoning_Immunity: break;
    case UNITABILITY_Missiles_Immunity: break;
    case UNITABILITY_Illusions_Immunity: break;
    case UNITABILITY_Cold_Immunity: break;
    case UNITABILITY_Magic_Immunity: break;
    case UNITABILITY_Death_Immunity: break;
    case UNITABILITY_Poison_Immunity: break;
    case UNITABILITY_Weapon_Immunity: break;
    case UNITABILITY_Flyer: break;
    case UNITABILITY_Lucky: break;
    case UNITABILITY_Summon_Demons_1: break;
    case UNITABILITY_Summon_Demons_2: break;
    case UNITABILITY_Caster_20_MP: break;
    case UNITABILITY_Caster_40_MP: break;
    case UNITABILITY_Standard: break;
    case UNITABILITY_Healing_Spell: break;
    case UNITABILITY_Fire_Ball_Spell: break;
    case UNITABILITY_Doombolt_Spell: break;
    case UNITABILITY_Immolation: break;
    case UNITABILITY_Web_Spell: break;
    case UNITABILITY_Cause_Fear_Spell: break;
    case UNITABILITY_Resistance_to_All: break;
    case UNITABILITY_Holy_Bonus: break;
    case UNITABILITY_Summoned_Unit: break;
    case UNITABILITY_Large_Shield: break;
    case UNITABILITY_Plane_Shift: break;
    case UNITABILITY_Wall_Crusher: break;
    case UNITABILITY_Healer: break;
    case UNITABILITY_Create_Outpost: break;
    case UNITABILITY_Invisibility: break;
    case UNITABILITY_Create_Undead: break;
    case UNITABILITY_Long_Range: break;
    case UNITABILITY_Land_Corruption: break;
    case UNITABILITY_Meld_With_Node: break;
    case UNITABILITY_Non_Corporeal: break;
    case UNITABILITY_Wind_Walking: break;
    case UNITABILITY_Regeneration: break;
    case UNITABILITY_Purify: break;
    case UNITABILITY_Negate_First_Strike: break;
    case UNITABILITY_Armor_Piercing: break;
    case UNITABILITY_First_Strike: break;
    case UNITABILITY_Poison_attack: break;
    case UNITABILITY_Life_Stealing: break;
    case UNITABILITY_Automatic_Damage: break;
    case UNITABILITY_Destruction: break;
    case UNITABILITY_Illusionary_attack: break;
    case UNITABILITY_Stoning_Touch: break;
    case UNITABILITY_No_effect05: break;
    ...
    default: std::cout << context << ": Unknown eUnitAbility = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eUnitEnchantment& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case UNITENCHANTMENT_Immolation: break;
    case UNITENCHANTMENT_Guardian_Wind: break;
    case UNITENCHANTMENT_Berserk: break;
    case UNITENCHANTMENT_Cloak_of_Fear: break;
    case UNITENCHANTMENT_Black_Channels: break;
    case UNITENCHANTMENT_Wraith_Form: break;
    case UNITENCHANTMENT_Regeneration: break;
    case UNITENCHANTMENT_Path_Finding: break;
    case UNITENCHANTMENT_Water_Walking: break;
    case UNITENCHANTMENT_Resist_Elements: break;
    case UNITENCHANTMENT_Elemental_Armor: break;
    case UNITENCHANTMENT_Stone_Skin: break;
    case UNITENCHANTMENT_Iron_Skin: break;
    case UNITENCHANTMENT_Endurance: break;
    case UNITENCHANTMENT_Spell_Lock: break;
    case UNITENCHANTMENT_Invisibility: break;
    case UNITENCHANTMENT_Wind_Walking: break;
    case UNITENCHANTMENT_Flight: break;
    case UNITENCHANTMENT_Resist_Magic: break;
    case UNITENCHANTMENT_Magic_Immunity: break;
    case UNITENCHANTMENT_Flame_Blade: break;
    case UNITENCHANTMENT_Eldritch_Weapon: break;
    case UNITENCHANTMENT_True_Sight: break;
    case UNITENCHANTMENT_Holy_Weapon: break;
    case UNITENCHANTMENT_Heroism: break;
    case UNITENCHANTMENT_Bless: break;
    case UNITENCHANTMENT_Lionheart: break;
    case UNITENCHANTMENT_Giant_Strength: break;
    case UNITENCHANTMENT_Planar_Travel: break;
    case UNITENCHANTMENT_Holy_Armor: break;
    case UNITENCHANTMENT_Righteousness: break;
    case UNITENCHANTMENT_Invulnerability: break;
    default: std::cout << context << ": Unknown eUnitEnchantment = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eUnitMutation& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case UNITMUTATION_Chaos_Channels_Demon_Skin: break;
    case UNITMUTATION_Chaos_Channels_Demon_Wings: break;
    case UNITMUTATION_Chaos_Channels_Fiery_Breath: break;
    case UNITMUTATION_Undead: break;
    case UNITMUTATION_Stasis_initial: break;
    case UNITMUTATION_Stasis_lingering: break;
    default: std::cout << context << ": Unknown eUnitMutation = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eUnit_Active& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case UNITACTIVE_awaiting_orders: break;
    case UNITACTIVE_finished: break;
    default: std::cout << context << ": Unknown eUnit_Active = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eUnit_Status8& rhs, const std::string& context)
{
    ...
    case UNITSTATUS8_unk6: break;
    case UNITSTATUS8_meld_GUESS: break;
    case UNITSTATUS8_build_GUESS: break;
    case UNITSTATUS8_seek_transport_GUESS: break;
    case UNITSTATUS8_unk10: break;
    case UNITSTATUS8_unk11: break;
    case UNITSTATUS8_unk12: break;
    case UNITSTATUS8_unk13: break;
    case UNITSTATUS8_unk14: break;
    case UNITSTATUS8_unk15: break;
    case UNITSTATUS8_move: break;
...
bool validate(const eUnit_Type& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case UNITTYPE_Dwarf: break;
    case UNITTYPE_Barbarian: break;
    case UNITTYPE_Sage: break;
    case UNITTYPE_Dervish: break;
    case UNITTYPE_Beastmaster: break;
    case UNITTYPE_Bard: break;
    case UNITTYPE_Orc_Warrior: break;
    case UNITTYPE_Healer: break;
    case UNITTYPE_Huntress: break;
    case UNITTYPE_Thief: break;
    case UNITTYPE_Druid: break;
    case UNITTYPE_War_Monk: break;
    case UNITTYPE_Warrior_Mage: break;
    case UNITTYPE_Magician: break;
    case UNITTYPE_Assassin: break;
    case UNITTYPE_Wind_Mage: break;
    case UNITTYPE_Ranger: break;
    case UNITTYPE_Draconian: break;
    case UNITTYPE_Witch: break;
    case UNITTYPE_Golden_One: break;
    case UNITTYPE_Ninja: break;
    case UNITTYPE_Rogue: break;
    case UNITTYPE_Amazon: break;
    case UNITTYPE_Warlock: break;
    case UNITTYPE_Unknown: break;
    case UNITTYPE_Illusionist: break;
    case UNITTYPE_Swordsman: break;
    case UNITTYPE_Priestess: break;
    case UNITTYPE_Paladin: break;
    case UNITTYPE_Black_Knight: break;
    case UNITTYPE_Elven_Archer: break;
    case UNITTYPE_Knight: break;
    case UNITTYPE_Necromancer: break;
    case UNITTYPE_Chaos_Warrior: break;
    case UNITTYPE_Chosen: break;
    case UNITTYPE_Trireme: break;
    case UNITTYPE_Galley: break;
    case UNITTYPE_Catapult: break;
    case UNITTYPE_Warship: break;
    case UNITTYPE_Barbarian_Spearmen: break;
    case UNITTYPE_Barbarian_Swordsmen: break;
    case UNITTYPE_Barbarian_Bowmen: break;
    case UNITTYPE_Barbarian_Cavalry: break;
    case UNITTYPE_Barbarian_Shaman: break;
    case UNITTYPE_Barbarian_Settlers: break;
    case UNITTYPE_Barbarian_Berserkers: break;
    case UNITTYPE_Beastmen_Spearmen: break;
    case UNITTYPE_Beastmen_Swordsmen: break;
    case UNITTYPE_Beastmen_Halberdiers: break;
    case UNITTYPE_Beastmen_Bowmen: break;
    case UNITTYPE_Beastmen_Priests: break;
    case UNITTYPE_Beastmen_Magicians: break;
    case UNITTYPE_Beastmen_Engineers: break;
    case UNITTYPE_Beastmen_Settlers: break;
    case UNITTYPE_Beastmen_Centaurs: break;
    case UNITTYPE_Beastmen_Manticores: break;
    case UNITTYPE_Beastmen_Minotaurs: break;
    case UNITTYPE_Dark_Elf_Spearmen: break;
    case UNITTYPE_Dark_Elf_Swordsmen: break;
    case UNITTYPE_Dark_Elf_Halberdiers: break;
    case UNITTYPE_Dark_Elf_Cavalry: break;
    case UNITTYPE_Dark_Elf_Priests: break;
    case UNITTYPE_Dark_Elf_Settlers: break;
    case UNITTYPE_Dark_Elf_Nightblades: break;
    case UNITTYPE_Dark_Elf_Warlocks: break;
    case UNITTYPE_Dark_Elf_Nightmares: break;
    case UNITTYPE_Draconian_Spearmen: break;
    case UNITTYPE_Draconian_Swordsmen: break;
    case UNITTYPE_Draconian_Halberdiers: break;
    case UNITTYPE_Draconian_Bowmen: break;
    case UNITTYPE_Draconian_Shaman: break;
    case UNITTYPE_Draconian_Magicians: break;
    case UNITTYPE_Draconian_Engineers: break;
    case UNITTYPE_Draconian_Settlers: break;
    case UNITTYPE_Draconian_Doom_Drakes: break;
    case UNITTYPE_Draconian_Air_Ship: break;
    case UNITTYPE_Dwarven_Swordsmen: break;
    case UNITTYPE_Dwarven_Halberdiers: break;
    case UNITTYPE_Dwarven_Engineers: break;
    case UNITTYPE_Dwarven_Hammerhands: break;
    case UNITTYPE_Dwarven_Steam_Cannon: break;
    case UNITTYPE_Dwarven_Golem: break;
    case UNITTYPE_Dwarven_Settlers: break;
    case UNITTYPE_Gnoll_Spearmen: break;
    case UNITTYPE_Gnoll_Swordsmen: break;
    case UNITTYPE_Gnoll_Halberdiers: break;
    case UNITTYPE_Gnoll_Bowmen: break;
    case UNITTYPE_Gnoll_Settlers: break;
    case UNITTYPE_Gnoll_Wolf_Riders: break;
    case UNITTYPE_Halfling_Spearmen: break;
    case UNITTYPE_Halfling_Swordsmen: break;
    case UNITTYPE_Halfling_Bowmen: break;
    case UNITTYPE_Halfling_Shaman: break;
    case UNITTYPE_Halfling_Settlers: break;
    case UNITTYPE_Halfling_Slingers: break;
    case UNITTYPE_High_Elf_Spearmen: break;
    case UNITTYPE_High_Elf_Swordsmen: break;
    case UNITTYPE_High_Elf_Halberdiers: break;
    case UNITTYPE_High_Elf_Cavalry: break;
    case UNITTYPE_High_Elf_Magicians: break;
    case UNITTYPE_High_Elf_Settlers: break;
    case UNITTYPE_High_Elf_Longbowmen: break;
    case UNITTYPE_High_Elf_Elven_Lords: break;
    case UNITTYPE_High_Elf_Pegasai: break;
    case UNITTYPE_High_Men_Spearmen: break;
    case UNITTYPE_High_Men_Swordsmen: break;
    case UNITTYPE_High_Men_Bowmen: break;
    case UNITTYPE_High_Men_Cavalry: break;
    case UNITTYPE_High_Men_Priests: break;
    case UNITTYPE_High_Men_Magicians: break;
    case UNITTYPE_High_Men_Engineers: break;
    case UNITTYPE_High_Men_Settlers: break;
    case UNITTYPE_High_Men_Pikemen: break;
    case UNITTYPE_High_Men_Paladins: break;
    case UNITTYPE_Klackon_Spearmen: break;
    case UNITTYPE_Klackon_Swordsmen: break;
    case UNITTYPE_Klackon_Halberdiers: break;
    case UNITTYPE_Klackon_Engineers: break;
    case UNITTYPE_Klackon_Settlers: break;
    case UNITTYPE_Klackon_Stag_Beetle: break;
    case UNITTYPE_Lizardman_Spearmen: break;
    case UNITTYPE_Lizardman_Swordsmen: break;
    case UNITTYPE_Lizardman_Halberdiers: break;
    case UNITTYPE_Lizardman_Javelineers: break;
    case UNITTYPE_Lizardman_Shaman: break;
    case UNITTYPE_Lizardman_Settlers: break;
    case UNITTYPE_Lizardman_Dragon_Turtle: break;
    case UNITTYPE_Nomad_Spearmen: break;
    case UNITTYPE_Nomad_Swordsmen: break;
    case UNITTYPE_Nomad_Bowmen: break;
    case UNITTYPE_Nomad_Priests: break;
    case UNITTYPE_Nomad_Magicians: break;
    case UNITTYPE_Nomad_Settlers: break;
    case UNITTYPE_Nomad_Horsebowmen: break;
    case UNITTYPE_Nomad_Pikemen: break;
    case UNITTYPE_Nomad_Rangers: break;
    case UNITTYPE_Nomad_Griffins: break;
    case UNITTYPE_Orc_Spearmen: break;
    case UNITTYPE_Orc_Swordsmen: break;
    case UNITTYPE_Orc_Halberdiers: break;
    case UNITTYPE_Orc_Bowmen: break;
    case UNITTYPE_Orc_Cavalry: break;
    case UNITTYPE_Orc_Shaman: break;
    case UNITTYPE_Orc_Magicians: break;
    case UNITTYPE_Orc_Engineers: break;
    case UNITTYPE_Orc_Settlers: break;
    case UNITTYPE_Orc_Wyvern_Riders: break;
    case UNITTYPE_Troll_Spearmen: break;
    case UNITTYPE_Troll_Swordsmen: break;
    case UNITTYPE_Troll_Halberdiers: break;
    case UNITTYPE_Troll_Shaman: break;
    case UNITTYPE_Troll_Settlers: break;
    case UNITTYPE_Troll_War_Trolls: break;
    case UNITTYPE_Troll_War_Mammoths: break;
    case UNITTYPE_Arcane_Magic_Spirit: break;
    case UNITTYPE_Red_Hell_Hounds: break;
    case UNITTYPE_Red_Gargoyles: break;
    case UNITTYPE_Red_Fire_Giant: break;
    case UNITTYPE_Red_Fire_Elemental: break;
    case UNITTYPE_Red_Chaos_Spawn: break;
    case UNITTYPE_Red_Chimera: break;
    case UNITTYPE_Red_Doom_Bat: break;
    case UNITTYPE_Red_Efreet: break;
    case UNITTYPE_Red_Hydra: break;
    case UNITTYPE_Red_Great_Drake: break;
    case UNITTYPE_Black_Skeletons: break;
    case UNITTYPE_Black_Ghouls: break;
    case UNITTYPE_Black_Night_Stalker: break;
    case UNITTYPE_Black_Werewolves: break;
    case UNITTYPE_Black_Demon: break;
    case UNITTYPE_Black_Wraiths: break;
    case UNITTYPE_Black_Shadow_Demons: break;
    case UNITTYPE_Black_Death_Knights: break;
    case UNITTYPE_Black_Demon_Lord: break;
    case UNITTYPE_Black_Zombies: break;
    case UNITTYPE_White_Unicorns: break;
    case UNITTYPE_White_Guardian_Spirit: break;
    case UNITTYPE_White_Angel: break;
    case UNITTYPE_White_Arch_Angel: break;
    case UNITTYPE_Green_War_Bears: break;
    case UNITTYPE_Green_Sprites: break;
    case UNITTYPE_Green_Cockatrices: break;
    case UNITTYPE_Green_Basilisk: break;
    case UNITTYPE_Green_Giant_Spiders: break;
    case UNITTYPE_Green_Stone_Giant: break;
    case UNITTYPE_Green_Colossus: break;
    case UNITTYPE_Green_Gorgons: break;
    case UNITTYPE_Green_Earth_Elemental: break;
    case UNITTYPE_Green_Behemoth: break;
    case UNITTYPE_Green_Great_Wyrm: break;
    case UNITTYPE_Blue_Floating_Island: break;
    case UNITTYPE_Blue_Phantom_Beast: break;
    case UNITTYPE_Blue_Phantom_Warriors: break;
    case UNITTYPE_Blue_Storm_Giant: break;
    case UNITTYPE_Blue_Air_Elemental: break;
    case UNITTYPE_Blue_Djinn: break;
    case UNITTYPE_Blue_Sky_Drake: break;
    case UNITTYPE_Blue_Nagas: break;
    default: std::cout << context << ": Unknown eUnit_Type = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eWar_Status& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case WARSTATUS_None: break;
    case WARSTATUS_Wizard_Pact: break;
    case WARSTATUS_Alliance: break;
    case WARSTATUS_War: break;
    default: std::cout << context << ": Unknown eWar_Status = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eWeaponType& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case WEAPON_normal: break;
    case WEAPON_magic: break;
    case WEAPON_mithril: break;
    case WEAPON_adamantium: break;
    default: std::cout << context << ": Unknown eWeaponType = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eYesNo16& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case YESNO16_No: break;
    case YESNO16_Yes: break;
    default: std::cout << context << ": Unknown eYesNo16 = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const eYesNo8& rhs, const std::string& context)
{
    ...
    switch (rhs)
    {
    case YESNO8_No: break;
    case YESNO8_Yes: break;
    default: std::cout << context << ": Unknown eYesNo8 = " << (int)rhs << "\n"; ok = false; break;
    }
    return ok;
}
...
bool validate(const Available_spell_page& rhs, const std::string& context)
{
    ...
    {
          std::ostringstream oss;
          oss << context << ".m_Spells_on_page[" << i << "]";
          if (!validate(rhs.m_Spells_on_page[i], oss.str())) ok = false;
    }
    return ok;
}

bool validate(const Battle_Figure& rhs, const std::string& context)
{
    bool ok = true;
...
bool validate(const Battle_Unit& rhs, const std::string& context)
{
    ...
    if (!validate(rhs.m_Ability_Flags, context + ".m_Ability_Flags")) ok = false;
...
bool validate(const Battlefield& rhs, const std::string& context)
{
    ...
    if (!validate(rhs.m_Central_structure, context + ".m_Central_structure")) ok = false;
...
bool validate(const BorlandStub& rhs, const std::string& context)
{
    ...
    {
          std::ostringstream oss;
          oss << context << ".entries[" << i << "]";
          if (!validate(rhs.entries[i], oss.str())) ok = false;
    }
    return ok;
}
...
{
    bool ok = true;
    if (!validate(rhs.m_Prerequisite1, context + ".m_Prerequisite1")) ok = false;
    if (!validate(rhs.m_Prerequisite2, context + ".m_Prerequisite2")) ok = false;
    if (!validate(rhs.m_Replaces_building, context + ".m_Replaces_building")) ok = false;
...
bool validate(const Building_Status& rhs, const std::string& context)
{
    ...
    if (!validate(rhs.Armory, context + ".Armory")) ok = false;
    if (!validate(rhs.Fighters_Guild, context + ".Fighters_Guild")) ok = false;
    if (!validate(rhs.Armorers_Guild, context + ".Armorers_Guild")) ok = false;
    if (!validate(rhs.War_College, context + ".War_College")) ok = false;
    if (!validate(rhs.Smithy, context + ".Smithy")) ok = false;
    if (!validate(rhs.Stable, context + ".Stable")) ok = false;
    if (!validate(rhs.Animists_Guild, context + ".Animists_Guild")) ok = false;
    if (!validate(rhs.Fantastic_Stable, context + ".Fantastic_Stable")) ok = false;
    if (!validate(rhs.Shipwright_Guild, context + ".Shipwright_Guild")) ok = false;
    if (!validate(rhs.Ship_Yard, context + ".Ship_Yard")) ok = false;
    if (!validate(rhs.Maritime_Guild, context + ".Maritime_Guild")) ok = false;
    if (!validate(rhs.Sawmill, context + ".Sawmill")) ok = false;
    if (!validate(rhs.Library, context + ".Library")) ok = false;
    if (!validate(rhs.Sages_Guild, context + ".Sages_Guild")) ok = false;
    if (!validate(rhs.Oracle, context + ".Oracle")) ok = false;
    if (!validate(rhs.Alchemist_Guild, context + ".Alchemist_Guild")) ok = false;
    if (!validate(rhs.University, context + ".University")) ok = false;
    if (!validate(rhs.Wizards_Guild, context + ".Wizards_Guild")) ok = false;
    if (!validate(rhs.Shrine, context + ".Shrine")) ok = false;
    if (!validate(rhs.Temple, context + ".Temple")) ok = false;
    if (!validate(rhs.Parthenon, context + ".Parthenon")) ok = false;
    if (!validate(rhs.Cathedral, context + ".Cathedral")) ok = false;
    if (!validate(rhs.Marketplace, context + ".Marketplace")) ok = false;
    if (!validate(rhs.Bank, context + ".Bank")) ok = false;
    if (!validate(rhs.Merchants_Guild, context + ".Merchants_Guild")) ok = false;
    if (!validate(rhs.Granary, context + ".Granary")) ok = false;
    if (!validate(rhs.Farmers_Market, context + ".Farmers_Market")) ok = false;
    if (!validate(rhs.Foresters_Guild, context + ".Foresters_Guild")) ok = false;
    if (!validate(rhs.Builders_Hall, context + ".Builders_Hall")) ok = false;
    if (!validate(rhs.Mechanicians_Guild, context + ".Mechanicians_Guild")) ok = false;
    if (!validate(rhs.Miners_Guild, context + ".Miners_Guild")) ok = false;
    if (!validate(rhs.City_Walls, context + ".City_Walls")) ok = false;
    return ok;
}
...
{
    bool ok = true;
    if (!validate(rhs.m_Race, context + ".m_Race")) ok = false;
    ...
    if (!validate(rhs.m_City_Enchantments, context + ".m_City_Enchantments")) ok = false;
    if (!validate(rhs.m_Nightshade, context + ".m_Nightshade")) ok = false;
    return ok;
}
...
{
    bool ok = true;
    if (!validate(rhs.Wall_of_Fire, context + ".Wall_of_Fire")) ok = false;
    if (!validate(rhs._Chaos_Rift_, context + "._Chaos_Rift_")) ok = false;
    if (!validate(rhs.Dark_Rituals, context + ".Dark_Rituals")) ok = false;
    if (!validate(rhs._Evil_Presence_, context + "._Evil_Presence_")) ok = false;
    if (!validate(rhs._Cursed_Lands_, context + "._Cursed_Lands_")) ok = false;
    if (!validate(rhs._Pestilence_, context + "._Pestilence_")) ok = false;
    if (!validate(rhs.Cloud_of_Shadow, context + ".Cloud_of_Shadow")) ok = false;
    if (!validate(rhs._Famine_, context + "._Famine_")) ok = false;
    if (!validate(rhs.Flying_Fortress, context + ".Flying_Fortress")) ok = false;
    if (!validate(rhs.Nature_Ward, context + ".Nature_Ward")) ok = false;
    if (!validate(rhs.Sorcery_Ward, context + ".Sorcery_Ward")) ok = false;
    if (!validate(rhs.Chaos_Ward, context + ".Chaos_Ward")) ok = false;
    if (!validate(rhs.Life_Ward, context + ".Life_Ward")) ok = false;
    if (!validate(rhs.Death_Ward, context + ".Death_Ward")) ok = false;
    if (!validate(rhs.Natures_Eye, context + ".Natures_Eye")) ok = false;
    if (!validate(rhs.Earth_Gate, context + ".Earth_Gate")) ok = false;
    if (!validate(rhs.Stream_of_Life, context + ".Stream_of_Life")) ok = false;
    if (!validate(rhs.Gaias_Blessing, context + ".Gaias_Blessing")) ok = false;
    if (!validate(rhs.Inspirations, context + ".Inspirations")) ok = false;
    if (!validate(rhs.Prosperity, context + ".Prosperity")) ok = false;
    if (!validate(rhs.Astral_Gate, context + ".Astral_Gate")) ok = false;
    if (!validate(rhs.Heavenly_Light, context + ".Heavenly_Light")) ok = false;
    if (!validate(rhs.Consecration, context + ".Consecration")) ok = false;
    if (!validate(rhs.Wall_of_Darkness, context + ".Wall_of_Darkness")) ok = false;
    if (!validate(rhs.Altar_of_Battle, context + ".Altar_of_Battle")) ok = false;
    return ok;
}
...
{
    bool ok = true;
    if (!validate(rhs.m_Sound_Effects, context + ".m_Sound_Effects")) ok = false;
    if (!validate(rhs.m_Background_Music, context + ".m_Background_Music")) ok = false;
    if (!validate(rhs.m_Event_Music, context + ".m_Event_Music")) ok = false;
    if (!validate(rhs.m_City_Spell_Events, context + ".m_City_Spell_Events")) ok = false;
    if (!validate(rhs.m_Overland_Spell_Events, context + ".m_Overland_Spell_Events")) ok = false;
    if (!validate(rhs.m_Summoning_Events, context + ".m_Summoning_Events")) ok = false;
    if (!validate(rhs.m_End_of_Turn_Summary, context + ".m_End_of_Turn_Summary")) ok = false;
    if (!validate(rhs.m_Raze_City, context + ".m_Raze_City")) ok = false;
    if (!validate(rhs.m_Random_Events, context + ".m_Random_Events")) ok = false;
    if (!validate(rhs.m_End_of_Turn_Wait, context + ".m_End_of_Turn_Wait")) ok = false;
    if (!validate(rhs.m_Stratic_Combat_Only, context + ".m_Stratic_Combat_Only")) ok = false;
    if (!validate(rhs.m_Auto_Unit_Information, context + ".m_Auto_Unit_Information")) ok = false;
    if (!validate(rhs.m_Enemy_Moves, context + ".m_Enemy_Moves")) ok = false;
    if (!validate(rhs.m_Enemy_Spells, context + ".m_Enemy_Spells")) ok = false;
    if (!validate(rhs.m_Spell_Book_Ordering, context + ".m_Spell_Book_Ordering")) ok = false;
    if (!validate(rhs.m_Spell_Animations, context + ".m_Spell_Animations")) ok = false;
    if (!validate(rhs.m_Show_Node_Owners, context + ".m_Show_Node_Owners")) ok = false;
    if (!validate(rhs.m_Expanding_Help, context + ".m_Expanding_Help")) ok = false;
    if (!validate(rhs.m_Difficulty, context + ".m_Difficulty")) ok = false;
    if (!validate(rhs.m_Land_Size, context + ".m_Land_Size")) ok = false;
    if (!validate(rhs.m_Magic_Powerful, context + ".m_Magic_Powerful")) ok = false;
    for (unsigned i = 0; i < 8; ++i)
    {
          std::ostringstream oss;
          oss << context << ".m_Slots_Saved[" << i << "]";
          if (!validate(rhs.m_Slots_Saved[i], oss.str())) ok = false;
    }
    for (unsigned i = 0; i < 8; ++i)
    {
          std::ostringstream oss;
          oss << context << ".m_Save_Names[" << i << "]";
          if (!validate(rhs.m_Save_Names[i], oss.str())) ok = false;
    }
    if (!validate(rhs.m_Movement_Animations, context + ".m_Movement_Animations")) ok = false;
    for (unsigned i = 0; i < 10; ++i)
    {
          std::ostringstream oss;
          oss << context << ".m_Save_Wizard_Names[" << i << "]";
          if (!validate(rhs.m_Save_Wizard_Names[i], oss.str())) ok = false;
    }
    return ok;
}
...
{
    bool ok = true;
    if (!validate(rhs.m_Random_pick_type, context + ".m_Random_pick_type")) ok = false;
    if (!validate(rhs.m_Hero_Abilities, context + ".m_Hero_Abilities")) ok = false;
    for (unsigned i = 0; i < 4; ++i)
    {
          std::ostringstream oss;
          oss << context << ".m_Spell[" << i << "]";
          if (!validate(rhs.m_Spell[i], oss.str())) ok = false;
    }
    return ok;
}
...
{
    bool ok = true;
    if (!validate(rhs.m_Level_Status, context + ".m_Level_Status")) ok = false;
    if (!validate(rhs.m_Hero_Abilities, context + ".m_Hero_Abilities")) ok = false;
    for (unsigned i = 0; i < 4; ++i)
    {
          std::ostringstream oss;
...
{
    bool ok = true;
    if (-1 == rhs.m_Unit_Nr) { return true; }
    for (unsigned i = 0; i < 3; ++i)
    {
          std::ostringstream oss;
          oss << context << ".m_Slot_Types[" << i << "]";
          if (!validate(rhs.m_Slot_Types[i], oss.str())) ok = false;
    }
    return ok;
}
...
{
    bool ok = true;
    if (-1 == rhs.m_Cost || 0 == rhs.m_Cost) { return true; }
    if (!validate(rhs.m_Icon, context + ".m_Icon")) ok = false;
    if (!validate(rhs.m_Slot_Required, context + ".m_Slot_Required")) ok = false;
    if (!validate(rhs.m_Item_Type, context + ".m_Item_Type")) ok = false;
    if (!validate(rhs.m_Bonuses, context + ".m_Bonuses")) ok = false;
    if (!validate(rhs.m_Spell_Number_Charged, context + ".m_Spell_Number_Charged")) ok = false;
...
{
    bool ok = true;
    if (!validate(rhs.m_Inhabitant, context + ".m_Inhabitant")) ok = false;
    return ok;
}
...
{
    bool ok = true;
    if (!validate(rhs.Dwarf, context + ".Dwarf")) ok = false;
    if (!validate(rhs.Barbarian, context + ".Barbarian")) ok = false;
    if (!validate(rhs.Sage, context + ".Sage")) ok = false;
    if (!validate(rhs.Dervish, context + ".Dervish")) ok = false;
    if (!validate(rhs.Beastmaster, context + ".Beastmaster")) ok = false;
    if (!validate(rhs.Bard, context + ".Bard")) ok = false;
    if (!validate(rhs.Orc_Warrior, context + ".Orc_Warrior")) ok = false;
    if (!validate(rhs.Healer, context + ".Healer")) ok = false;
    if (!validate(rhs.Huntress, context + ".Huntress")) ok = false;
    if (!validate(rhs.Thief, context + ".Thief")) ok = false;
    if (!validate(rhs.Druid, context + ".Druid")) ok = false;
    if (!validate(rhs.War_Monk, context + ".War_Monk")) ok = false;
    if (!validate(rhs.Warrior_Mage, context + ".Warrior_Mage")) ok = false;
    if (!validate(rhs.Magician, context + ".Magician")) ok = false;
    if (!validate(rhs.Assassin, context + ".Assassin")) ok = false;
    if (!validate(rhs.Wind_Mage, context + ".Wind_Mage")) ok = false;
    if (!validate(rhs.Ranger, context + ".Ranger")) ok = false;
    if (!validate(rhs.Draconian, context + ".Draconian")) ok = false;
    if (!validate(rhs.Witch, context + ".Witch")) ok = false;
    if (!validate(rhs.Golden_One, context + ".Golden_One")) ok = false;
    if (!validate(rhs.Ninja, context + ".Ninja")) ok = false;
    if (!validate(rhs.Rogue, context + ".Rogue")) ok = false;
    if (!validate(rhs.Amazon, context + ".Amazon")) ok = false;
    if (!validate(rhs.Warlock, context + ".Warlock")) ok = false;
    if (!validate(rhs.Unknown, context + ".Unknown")) ok = false;
    if (!validate(rhs.Illusionist, context + ".Illusionist")) ok = false;
    if (!validate(rhs.Swordsman, context + ".Swordsman")) ok = false;
    if (!validate(rhs.Priestess, context + ".Priestess")) ok = false;
    if (!validate(rhs.Paladin, context + ".Paladin")) ok = false;
    if (!validate(rhs.Black_Knight, context + ".Black_Knight")) ok = false;
    if (!validate(rhs.Elven_Archer, context + ".Elven_Archer")) ok = false;
    if (!validate(rhs.Knight, context + ".Knight")) ok = false;
...
bool validate(const MapRow_Bonus& rhs, const std::string& context)
{
    ...
    {
          std::ostringstream oss;
          oss << context << ".m_Bonus_Deposit[" << i << "]";
          if (!validate(rhs.m_Bonus_Deposit[i], oss.str())) ok = false;
    }
    return ok;
}
...
bool validate(const MapRow_Terrain& rhs, const std::string& context)
{
    ...
    {
          std::ostringstream oss;
          oss << context << ".m_Tile[" << i << "]";
          if (!validate(rhs.m_Tile[i], oss.str())) ok = false;
    }
    return ok;
}
...
bool validate(const Map_Movement& rhs, const std::string& context)
{
    ...
    {
          std::ostringstream oss;
          oss << context << ".m_Unused_Row[" << i << "]";
          if (!validate(rhs.m_Unused_Row[i], oss.str())) ok = false;
    }
    for (unsigned i = 0; i < 40; ++i)
    {
          std::ostringstream oss;
          oss << context << ".m_Walking_Row[" << i << "]";
          if (!validate(rhs.m_Walking_Row[i], oss.str())) ok = false;
    }
    for (unsigned i = 0; i < 40; ++i)
    {
          std::ostringstream oss;
          oss << context << ".m_Forester_Row[" << i << "]";
          if (!validate(rhs.m_Forester_Row[i], oss.str())) ok = false;
    }
    for (unsigned i = 0; i < 40; ++i)
    {
          std::ostringstream oss;
          oss << context << ".m_Mountaineer_Row[" << i << "]";
          if (!validate(rhs.m_Mountaineer_Row[i], oss.str())) ok = false;
    }
    for (unsigned i = 0; i < 40; ++i)
    {
          std::ostringstream oss;
          oss << context << ".m_Swimming_Row[" << i << "]";
          if (!validate(rhs.m_Swimming_Row[i], oss.str())) ok = false;
    }
    for (unsigned i = 0; i < 40; ++i)
    {
          std::ostringstream oss;
...
{
    bool ok = true;
    if (!validate(rhs.m_Hero_Types, context + ".m_Hero_Types")) ok = false;
    for (unsigned i = 0; i < 4 + 115; ++i)
    {
          std::ostringstream oss;
          oss << context << ".m_Normal_Units[" << i << "]";
          if (!validate(rhs.m_Normal_Units[i], oss.str())) ok = false;
    }
    for (unsigned i = 0; i < 44; ++i)
    {
          std::ostringstream oss;
          oss << context << ".m_Summoned_Units[" << i << "]";
          if (!validate(rhs.m_Summoned_Units[i], oss.str())) ok = false;
    }
    for (unsigned i = 0; i < 14; ++i)
    {
          std::ostringstream oss;
          oss << context << ".m_Race_Data[" << i << "]";
          if (!validate(rhs.m_Race_Data[i], oss.str())) ok = false;
    }
    if (!validate(rhs.m_Upkeep_Enchantments, context + ".m_Upkeep_Enchantments")) ok = false;
    for (unsigned i = 0; i < eDifficulty_MAX; ++i)
    {
          std::ostringstream oss;
...
bool validate(const MoMMagicDataSegment& rhs, const std::string& context)
{
    ...
    {
          std::ostringstream oss;
          oss << context << ".m_Hero_Stats_Initializers[" << i << "]";
          if (!validate(rhs.m_Hero_Stats_Initializers[i], oss.str())) ok = false;
    }
    for (unsigned i = 0; i < rhs.m_Game_Data.m_Number_of_Wizards; ++i)
    {
          std::ostringstream oss;
    ...
    {
          std::ostringstream oss;
          oss << context << ".m_Spells_selected_of_Realm[" << i << "]";
          if (!validate(rhs.m_Spells_selected_of_Realm[i], oss.str())) ok = false;
    }
    if (!validate(rhs.m_Game_Data, context + ".m_Game_Data")) ok = false;
    if (!validate(rhs.m_Game_Settings, context + ".m_Game_Settings")) ok = false;
    for (unsigned i = 0; i < eSpell_MAX; ++i)
    {
          std::ostringstream oss;
          oss << context << ".m_Spell_Selected[" << i << "]";
          if (!validate(rhs.m_Spell_Selected[i], oss.str())) ok = false;
    }
    if (!validate(rhs.m_Select_Wizard_Shown, context + ".m_Select_Wizard_Shown")) ok = false;
    return ok;
}
...
bool validate(const Node_Attr& rhs, const std::string& context)
{
    ...
    if (!validate(rhs.m_Plane, context + ".m_Plane")) ok = false;
    if (!validate(rhs.m_Owner, context + ".m_Owner")) ok = false;
    if (!validate(rhs.m_Node_Type, context + ".m_Node_Type")) ok = false;
    return ok;
}
...
bool validate(const SaveGame& rhs, const std::string& context)
{
    ...
    {
          std::ostringstream oss;
          oss << context << ".m_List_Hero_stats[" << i << "]";
          if (!validate(rhs.m_List_Hero_stats[i], oss.str())) ok = false;
    }
    if (!validate(rhs.m_Game_Data, context + ".m_Game_Data")) ok = false;
    for (unsigned i = 0; i < rhs.m_Game_Data.m_Number_of_Wizards; ++i)
    {
    ...
    {
          std::ostringstream oss;
          oss << context << ".m_Cities[" << i << "]";
          if (!validate(rhs.m_Cities[i], oss.str())) ok = false;
    }
    for (unsigned i = 0; i < rhs.m_Game_Data.m_Number_of_Units; ++i)
    {
          std::ostringstream oss;
...
{
    bool ok = true;
    if (!validate(rhs.Alchemy, context + ".Alchemy")) ok = false;
    if (!validate(rhs.Warlord, context + ".Warlord")) ok = false;
    if (!validate(rhs.Chaos_Master, context + ".Chaos_Master")) ok = false;
    if (!validate(rhs.Nature_Master, context + ".Nature_Master")) ok = false;
    if (!validate(rhs.Sorcery_Master, context + ".Sorcery_Master")) ok = false;
    if (!validate(rhs.Infernal_Power, context + ".Infernal_Power")) ok = false;
    if (!validate(rhs.Divine_Power, context + ".Divine_Power")) ok = false;
    if (!validate(rhs.Sage_Master, context + ".Sage_Master")) ok = false;
    if (!validate(rhs.Channeller, context + ".Channeller")) ok = false;
    if (!validate(rhs.Myrran, context + ".Myrran")) ok = false;
    if (!validate(rhs.Archmage, context + ".Archmage")) ok = false;
    if (!validate(rhs.Mana_Focusing, context + ".Mana_Focusing")) ok = false;
    if (!validate(rhs.Node_Mastery, context + ".Node_Mastery")) ok = false;
    if (!validate(rhs.Famous, context + ".Famous")) ok = false;
    if (!validate(rhs.Runemaster, context + ".Runemaster")) ok = false;
    if (!validate(rhs.Conjurer, context + ".Conjurer")) ok = false;
    if (!validate(rhs.Charismatic, context + ".Charismatic")) ok = false;
    if (!validate(rhs.Artificer, context + ".Artificer")) ok = false;
    return ok;
}
...
bool validate(const Spells_Known& rhs, const std::string& context)
{
    ...
    if (!validate(rhs.Giant_Strength, context + ".Giant_Strength")) ok = false;
    if (!validate(rhs.Web, context + ".Web")) ok = false;
    if (!validate(rhs.War_Bears, context + ".War_Bears")) ok = false;
    if (!validate(rhs.Stone_Skin, context + ".Stone_Skin")) ok = false;
    if (!validate(rhs.Water_Walking, context + ".Water_Walking")) ok = false;
    if (!validate(rhs.Sprites, context + ".Sprites")) ok = false;
    if (!validate(rhs.Earth_Lore, context + ".Earth_Lore")) ok = false;
    if (!validate(rhs.Cracks_Call, context + ".Cracks_Call")) ok = false;
    if (!validate(rhs.Natures_eye, context + ".Natures_eye")) ok = false;
    if (!validate(rhs.Ice_Bolt, context + ".Ice_Bolt")) ok = false;
    if (!validate(rhs.Giant_Spiders, context + ".Giant_Spiders")) ok = false;
    if (!validate(rhs.Change_Terrain, context + ".Change_Terrain")) ok = false;
    if (!validate(rhs.Path_Finding, context + ".Path_Finding")) ok = false;
    if (!validate(rhs.Cockatrices, context + ".Cockatrices")) ok = false;
    if (!validate(rhs.Transmute, context + ".Transmute")) ok = false;
    if (!validate(rhs.Natures_Cures, context + ".Natures_Cures")) ok = false;
    if (!validate(rhs.Basilisk, context + ".Basilisk")) ok = false;
    if (!validate(rhs.Elemental_Armor, context + ".Elemental_Armor")) ok = false;
    if (!validate(rhs.Petrify, context + ".Petrify")) ok = false;
    if (!validate(rhs.Stone_Giant, context + ".Stone_Giant")) ok = false;
    if (!validate(rhs.Iron_Skin, context + ".Iron_Skin")) ok = false;
    if (!validate(rhs.Ice_Storm, context + ".Ice_Storm")) ok = false;
    if (!validate(rhs.Earthquake, context + ".Earthquake")) ok = false;
    if (!validate(rhs.Gorgons, context + ".Gorgons")) ok = false;
    if (!validate(rhs.Move_Fortress, context + ".Move_Fortress")) ok = false;
    if (!validate(rhs.Gaias_Blessing, context + ".Gaias_Blessing")) ok = false;
    if (!validate(rhs.Earth_Elemental, context + ".Earth_Elemental")) ok = false;
    if (!validate(rhs.Regeneration, context + ".Regeneration")) ok = false;
    if (!validate(rhs.Behemoth, context + ".Behemoth")) ok = false;
    if (!validate(rhs.Entangle, context + ".Entangle")) ok = false;
    if (!validate(rhs.Nature_Awareness, context + ".Nature_Awareness")) ok = false;
    if (!validate(rhs.Call_Lightning, context + ".Call_Lightning")) ok = false;
    if (!validate(rhs.Colossus, context + ".Colossus")) ok = false;
    if (!validate(rhs.Earth_Gate, context + ".Earth_Gate")) ok = false;
    if (!validate(rhs.Herb_Mastery, context + ".Herb_Mastery")) ok = false;
    if (!validate(rhs.Great_Wyrm, context + ".Great_Wyrm")) ok = false;
    if (!validate(rhs.Natures_Wrath, context + ".Natures_Wrath")) ok = false;
    if (!validate(rhs.Resist_Magic, context + ".Resist_Magic")) ok = false;
    if (!validate(rhs.Dispel_Magic_True, context + ".Dispel_Magic_True")) ok = false;
    if (!validate(rhs.Floating_Island, context + ".Floating_Island")) ok = false;
    if (!validate(rhs.Guardian_Wind, context + ".Guardian_Wind")) ok = false;
    if (!validate(rhs.Phantom_Warriors, context + ".Phantom_Warriors")) ok = false;
    if (!validate(rhs.Confusion, context + ".Confusion")) ok = false;
    if (!validate(rhs.Word_of_Recall, context + ".Word_of_Recall")) ok = false;
    if (!validate(rhs.Counter_Magic, context + ".Counter_Magic")) ok = false;
    if (!validate(rhs.Nagas, context + ".Nagas")) ok = false;
    if (!validate(rhs.Psionic_Blast, context + ".Psionic_Blast")) ok = false;
    if (!validate(rhs.Blur, context + ".Blur")) ok = false;
    if (!validate(rhs.Disenchant_True, context + ".Disenchant_True")) ok = false;
    if (!validate(rhs.Vertigo, context + ".Vertigo")) ok = false;
    if (!validate(rhs.Spell_Lock, context + ".Spell_Lock")) ok = false;
    if (!validate(rhs.Enchant_Road, context + ".Enchant_Road")) ok = false;
    if (!validate(rhs.Flight, context + ".Flight")) ok = false;
    if (!validate(rhs.Wind_Mastery, context + ".Wind_Mastery")) ok = false;
    if (!validate(rhs.Spell_Blast, context + ".Spell_Blast")) ok = false;
    if (!validate(rhs.Aura_of_Majesty, context + ".Aura_of_Majesty")) ok = false;
    if (!validate(rhs.Phantom_Beast, context + ".Phantom_Beast")) ok = false;
    if (!validate(rhs.Disjunction_True, context + ".Disjunction_True")) ok = false;
    if (!validate(rhs.Invisibility, context + ".Invisibility")) ok = false;
    if (!validate(rhs.Wind_Walking, context + ".Wind_Walking")) ok = false;
    if (!validate(rhs.Banish, context + ".Banish")) ok = false;
    if (!validate(rhs.Storm_Giant, context + ".Storm_Giant")) ok = false;
    if (!validate(rhs.Air_Elemental, context + ".Air_Elemental")) ok = false;
    if (!validate(rhs.Mind_Storm, context + ".Mind_Storm")) ok = false;
    if (!validate(rhs.Stasis, context + ".Stasis")) ok = false;
    if (!validate(rhs.Magic_Immunity, context + ".Magic_Immunity")) ok = false;
    if (!validate(rhs.Haste, context + ".Haste")) ok = false;
    if (!validate(rhs.Djinn, context + ".Djinn")) ok = false;
    if (!validate(rhs.Spell_Ward, context + ".Spell_Ward")) ok = false;
    if (!validate(rhs.Creature_Binding, context + ".Creature_Binding")) ok = false;
    if (!validate(rhs.Mass_Invisibility, context + ".Mass_Invisibility")) ok = false;
    if (!validate(rhs.Great_Unsummoning, context + ".Great_Unsummoning")) ok = false;
    if (!validate(rhs.Spell_Binding, context + ".Spell_Binding")) ok = false;
    if (!validate(rhs.Flying_Fortress, context + ".Flying_Fortress")) ok = false;
    if (!validate(rhs.Sky_Drake, context + ".Sky_Drake")) ok = false;
    if (!validate(rhs.Suppress_Magic, context + ".Suppress_Magic")) ok = false;
    if (!validate(rhs.Time_Stop, context + ".Time_Stop")) ok = false;
    if (!validate(rhs.Warp_Wood, context + ".Warp_Wood")) ok = false;
    if (!validate(rhs.Disrupt, context + ".Disrupt")) ok = false;
    if (!validate(rhs.Fire_Bolt, context + ".Fire_Bolt")) ok = false;
    if (!validate(rhs.Hell_Hounds, context + ".Hell_Hounds")) ok = false;
    if (!validate(rhs.Corruption, context + ".Corruption")) ok = false;
    if (!validate(rhs.Eldritch_Weapon, context + ".Eldritch_Weapon")) ok = false;
    if (!validate(rhs.Wall_of_Fire, context + ".Wall_of_Fire")) ok = false;
    if (!validate(rhs.Shatter, context + ".Shatter")) ok = false;
    if (!validate(rhs.Warp_Creature, context + ".Warp_Creature")) ok = false;
    if (!validate(rhs.Fire_Elemental, context + ".Fire_Elemental")) ok = false;
    if (!validate(rhs.Lightning_Bolt, context + ".Lightning_Bolt")) ok = false;
    if (!validate(rhs.Fire_Giant, context + ".Fire_Giant")) ok = false;
    if (!validate(rhs.Chaos_Channels, context + ".Chaos_Channels")) ok = false;
    if (!validate(rhs.Flame_Blade, context + ".Flame_Blade")) ok = false;
    if (!validate(rhs.Gargoyles, context + ".Gargoyles")) ok = false;
    if (!validate(rhs.Fireball, context + ".Fireball")) ok = false;
    if (!validate(rhs.Doombat, context + ".Doombat")) ok = false;
    if (!validate(rhs.Raise_Volcano, context + ".Raise_Volcano")) ok = false;
    if (!validate(rhs.Immolation, context + ".Immolation")) ok = false;
    if (!validate(rhs.Chimeras, context + ".Chimeras")) ok = false;
    if (!validate(rhs.Warp_Lightning, context + ".Warp_Lightning")) ok = false;
    if (!validate(rhs.Metal_Fires, context + ".Metal_Fires")) ok = false;
    if (!validate(rhs.Chaos_Spawn, context + ".Chaos_Spawn")) ok = false;
    if (!validate(rhs.Doom_Bolt, context + ".Doom_Bolt")) ok = false;
    if (!validate(rhs.Magic_Vortex, context + ".Magic_Vortex")) ok = false;
    if (!validate(rhs.Efreet, context + ".Efreet")) ok = false;
    if (!validate(rhs.Fire_Storm, context + ".Fire_Storm")) ok = false;
    if (!validate(rhs.Warp_Reality, context + ".Warp_Reality")) ok = false;
    if (!validate(rhs.Flame_Strike, context + ".Flame_Strike")) ok = false;
    if (!validate(rhs.Chaos_Rift, context + ".Chaos_Rift")) ok = false;
    if (!validate(rhs.Hydra, context + ".Hydra")) ok = false;
    if (!validate(rhs.Disintegrate, context + ".Disintegrate")) ok = false;
    if (!validate(rhs.Meteor_Storm, context + ".Meteor_Storm")) ok = false;
    if (!validate(rhs.Great_Wasting, context + ".Great_Wasting")) ok = false;
    if (!validate(rhs.Call_Chaos, context + ".Call_Chaos")) ok = false;
    if (!validate(rhs.Chaos_Surge, context + ".Chaos_Surge")) ok = false;
    if (!validate(rhs.Doom_Mastery, context + ".Doom_Mastery")) ok = false;
    if (!validate(rhs.Great_Drake, context + ".Great_Drake")) ok = false;
    if (!validate(rhs.Call_The_Void, context + ".Call_The_Void")) ok = false;
    if (!validate(rhs.Armageddon, context + ".Armageddon")) ok = false;
    if (!validate(rhs.Bless, context + ".Bless")) ok = false;
    if (!validate(rhs.Star_Fires, context + ".Star_Fires")) ok = false;
    if (!validate(rhs.Endurance, context + ".Endurance")) ok = false;
    if (!validate(rhs.Holy_Weapon, context + ".Holy_Weapon")) ok = false;
    if (!validate(rhs.Healing, context + ".Healing")) ok = false;
    if (!validate(rhs.Holy_Armor, context + ".Holy_Armor")) ok = false;
    if (!validate(rhs.Just_Cause, context + ".Just_Cause")) ok = false;
    if (!validate(rhs.True_Light, context + ".True_Light")) ok = false;
    if (!validate(rhs.Guardian_Spirit, context + ".Guardian_Spirit")) ok = false;
    if (!validate(rhs.Heroism, context + ".Heroism")) ok = false;
    if (!validate(rhs.True_Sight, context + ".True_Sight")) ok = false;
    if (!validate(rhs.Plane_Shift, context + ".Plane_Shift")) ok = false;
    if (!validate(rhs.Resurrection, context + ".Resurrection")) ok = false;
    if (!validate(rhs.Dispel_Evil, context + ".Dispel_Evil")) ok = false;
    if (!validate(rhs.Planar_Seal, context + ".Planar_Seal")) ok = false;
    if (!validate(rhs.Unicorns, context + ".Unicorns")) ok = false;
    if (!validate(rhs.Raise_Dead, context + ".Raise_Dead")) ok = false;
    if (!validate(rhs.Planar_Travel, context + ".Planar_Travel")) ok = false;
    if (!validate(rhs.Heavenly_Light, context + ".Heavenly_Light")) ok = false;
    if (!validate(rhs.Prayer, context + ".Prayer")) ok = false;
    if (!validate(rhs.Lionheart, context + ".Lionheart")) ok = false;
    if (!validate(rhs.Incarnation, context + ".Incarnation")) ok = false;
    if (!validate(rhs.Invulnerability, context + ".Invulnerability")) ok = false;
    if (!validate(rhs.Righteousness, context + ".Righteousness")) ok = false;
    if (!validate(rhs.Prosperity, context + ".Prosperity")) ok = false;
    if (!validate(rhs.Altar_of_Battle, context + ".Altar_of_Battle")) ok = false;
    if (!validate(rhs.Angel, context + ".Angel")) ok = false;
    if (!validate(rhs.Stream_of_Life, context + ".Stream_of_Life")) ok = false;
    if (!validate(rhs.Mass_Healing, context + ".Mass_Healing")) ok = false;
    if (!validate(rhs.Holy_Word, context + ".Holy_Word")) ok = false;
    if (!validate(rhs.High_Prayer, context + ".High_Prayer")) ok = false;
    if (!validate(rhs.Inspirations, context + ".Inspirations")) ok = false;
    if (!validate(rhs.Astral_Gate, context + ".Astral_Gate")) ok = false;
    if (!validate(rhs.Holy_Arms, context + ".Holy_Arms")) ok = false;
    if (!validate(rhs.Consecration, context + ".Consecration")) ok = false;
    if (!validate(rhs.Life_Force, context + ".Life_Force")) ok = false;
    if (!validate(rhs.Tranquility, context + ".Tranquility")) ok = false;
    if (!validate(rhs.Crusade, context + ".Crusade")) ok = false;
    if (!validate(rhs.Arch_Angel, context + ".Arch_Angel")) ok = false;
    if (!validate(rhs.Charm_of_Life, context + ".Charm_of_Life")) ok = false;
    if (!validate(rhs.Skeletons, context + ".Skeletons")) ok = false;
    if (!validate(rhs.Weakness, context + ".Weakness")) ok = false;
    if (!validate(rhs.Dark_Rituals, context + ".Dark_Rituals")) ok = false;
    if (!validate(rhs.Cloak_of_Fear, context + ".Cloak_of_Fear")) ok = false;
    if (!validate(rhs.Black_Sleep, context + ".Black_Sleep")) ok = false;
    if (!validate(rhs.Ghouls, context + ".Ghouls")) ok = false;
    if (!validate(rhs.Life_Drain, context + ".Life_Drain")) ok = false;
    if (!validate(rhs.Terror, context + ".Terror")) ok = false;
    if (!validate(rhs.Darkness, context + ".Darkness")) ok = false;
    if (!validate(rhs.Mana_Leak, context + ".Mana_Leak")) ok = false;
    if (!validate(rhs.Drain_Power, context + ".Drain_Power")) ok = false;
    if (!validate(rhs.Possession, context + ".Possession")) ok = false;
    if (!validate(rhs.Lycantrophy, context + ".Lycantrophy")) ok = false;
    if (!validate(rhs.Black_Prayer, context + ".Black_Prayer")) ok = false;
    if (!validate(rhs.Black_Channels, context + ".Black_Channels")) ok = false;
    if (!validate(rhs.Night_Stalker, context + ".Night_Stalker")) ok = false;
    if (!validate(rhs.Subversion, context + ".Subversion")) ok = false;
    if (!validate(rhs.Wall_of_Darkness, context + ".Wall_of_Darkness")) ok = false;
    if (!validate(rhs.Berserk, context + ".Berserk")) ok = false;
    if (!validate(rhs.Shadow_Demons, context + ".Shadow_Demons")) ok = false;
    if (!validate(rhs.Wraith_Form, context + ".Wraith_Form")) ok = false;
    if (!validate(rhs.Wrack, context + ".Wrack")) ok = false;
    if (!validate(rhs.Evil_Presence, context + ".Evil_Presence")) ok = false;
    if (!validate(rhs.Wraiths, context + ".Wraiths")) ok = false;
    if (!validate(rhs.Cloud_of_Shadow, context + ".Cloud_of_Shadow")) ok = false;
    if (!validate(rhs.Warp_Node, context + ".Warp_Node")) ok = false;
    if (!validate(rhs.Black_Wind, context + ".Black_Wind")) ok = false;
    if (!validate(rhs.Zombie_Mastery, context + ".Zombie_Mastery")) ok = false;
    if (!validate(rhs.Famine, context + ".Famine")) ok = false;
    if (!validate(rhs.Cursed_Lands, context + ".Cursed_Lands")) ok = false;
    if (!validate(rhs.Cruel_Unminding, context + ".Cruel_Unminding")) ok = false;
    if (!validate(rhs.Word_of_Death, context + ".Word_of_Death")) ok = false;
    if (!validate(rhs.Death_Knights, context + ".Death_Knights")) ok = false;
    if (!validate(rhs.Death_Spell, context + ".Death_Spell")) ok = false;
    if (!validate(rhs.Animate_dead, context + ".Animate_dead")) ok = false;
    if (!validate(rhs.Pestilence, context + ".Pestilence")) ok = false;
    if (!validate(rhs.Eternal_Night, context + ".Eternal_Night")) ok = false;
    if (!validate(rhs.Evil_Omens, context + ".Evil_Omens")) ok = false;
    if (!validate(rhs.Death_Wish, context + ".Death_Wish")) ok = false;
    if (!validate(rhs.Demon_Lord, context + ".Demon_Lord")) ok = false;
    if (!validate(rhs.Magic_Spirit, context + ".Magic_Spirit")) ok = false;
    if (!validate(rhs.Dispel_Magic, context + ".Dispel_Magic")) ok = false;
    if (!validate(rhs.Summoning_Circle, context + ".Summoning_Circle")) ok = false;
    if (!validate(rhs.Disenchant_Area, context + ".Disenchant_Area")) ok = false;
    if (!validate(rhs.Recall_Hero, context + ".Recall_Hero")) ok = false;
    if (!validate(rhs.Detect_Magic, context + ".Detect_Magic")) ok = false;
    if (!validate(rhs.Enchant_Item, context + ".Enchant_Item")) ok = false;
    if (!validate(rhs.Summon_Hero, context + ".Summon_Hero")) ok = false;
    if (!validate(rhs.Awareness, context + ".Awareness")) ok = false;
    if (!validate(rhs.Disjunction, context + ".Disjunction")) ok = false;
    if (!validate(rhs.Create_Artifact, context + ".Create_Artifact")) ok = false;
    if (!validate(rhs.Summon_Champion, context + ".Summon_Champion")) ok = false;
    if (!validate(rhs.Spell_Of_Mastery, context + ".Spell_Of_Mastery")) ok = false;
    if (!validate(rhs.Spell_Of_Return, context + ".Spell_Of_Return")) ok = false;
    return ok;
}
...
bool validate(const Tower_Node_Lair& rhs, const std::string& context)
{
    ...
    if (!validate(rhs.m_Type, context + ".m_Type")) ok = false;
    if (!validate(rhs.m_Inhabitant1, context + ".m_Inhabitant1")) ok = false;
    if (!validate(rhs.m_Inhabitant2, context + ".m_Inhabitant2")) ok = false;
    if (!validate(rhs.m_Reward_Specials, context + ".m_Reward_Specials")) ok = false;
    if (!validate(rhs.m_Flags, context + ".m_Flags")) ok = false;
    return ok;
}
...
bool validate(const Unit& rhs, const std::string& context)
{
    ...
    if (!validate(rhs.m_Plane, context + ".m_Plane")) ok = false;
    if (!validate(rhs.m_Owner, context + ".m_Owner")) ok = false;
    if (!validate(rhs.m_Unit_Type, context + ".m_Unit_Type")) ok = false;
    if (!validate(rhs.m_Active, context + ".m_Active")) ok = false;
    if (!validate(rhs.m_Status, context + ".m_Status")) ok = false;
    if (!validate(rhs.m_Level, context + ".m_Level")) ok = false;
    if (!validate(rhs.m_Weapon_Mutation, context + ".m_Weapon_Mutation")) ok = false;
    if (!validate(rhs.m_Unit_Enchantment, context + ".m_Unit_Enchantment")) ok = false;
    return ok;
}
...
bool validate(const UnitView_Lines& rhs, const std::string& context)
{
    bool ok = true;
    for (unsigned i = 0; i < 40; ++i)
    {
...
{
    bool ok = true;
    if (!validate(rhs.m_Portrait, context + ".m_Portrait")) ok = false;
    if (!validate(rhs.m_Home_Race, context + ".m_Home_Race")) ok = false;
    if (!validate(rhs.m_BannerColor, context + ".m_BannerColor")) ok = false;
    if (!validate(rhs.m_Personality, context + ".m_Personality")) ok = false;
    if (!validate(rhs.m_Objective, context + ".m_Objective")) ok = false;
    if (!validate(rhs.m_Plane_of_Summoning_Circle, context + ".m_Plane_of_Summoning_Circle")) ok = false;
    for (unsigned i = 0; i < 8; ++i)
    {
          std::ostringstream oss;
          oss << context << ".m_Research_Spell_candidates[" << i << "]";
          if (!validate(rhs.m_Research_Spell_candidates[i], oss.str())) ok = false;
    }
    if (!validate(rhs.m_Spell_being_cast, context + ".m_Spell_being_cast")) ok = false;
    if (!validate(rhs.m_Tax_Rate, context + ".m_Tax_Rate")) ok = false;
    if (!validate(rhs.m_Skills, context + ".m_Skills")) ok = false;
    for (unsigned i = 0; i < gMAX_HIRED_HEROES; ++i)
    {
          std::ostringstream oss;
          oss << context << ".m_Heroes_hired_by_wizard[" << i << "]";
          if (!validate(rhs.m_Heroes_hired_by_wizard[i], oss.str())) ok = false;
    }
    for (unsigned i = 0; i < 6; ++i)
    {
          std::ostringstream oss;
          oss << context << ".m_War_Status[" << i << "]";
          if (!validate(rhs.m_War_Status[i], oss.str())) ok = false;
    }
    if (!validate(rhs.m_Researching_Spell, context + ".m_Researching_Spell")) ok = false;
    if (!validate(rhs.m_Spells_Known, context + ".m_Spells_Known")) ok = false;
    if (!validate(rhs.m_Global_Enchantments, context + ".m_Global_Enchantments")) ok = false;
    if (!validate(rhs.m_Books_Color, context + ".m_Books_Color")) ok = false;
    return ok;
}
...
{
    bool ok = true;
    if (!validate(rhs.m_Skill, context + ".m_Skill")) ok = false;
    return ok;
}
...
{
    bool ok = true;
    if (!validate(rhs.s, context + ".s")) ok = false;
    return ok;
}
...
bool validate(const unionBuilding_Status& rhs, const std::string& context)
{
    ...
    for (unsigned i = 0; i < eBuilding_MAX; ++i)
    {
          std::ostringstream oss;
          oss << context << ".a[" << i << "]";
          if (!validate(rhs.a[i], oss.str())) ok = false;
    }
    if (!validate(rhs.s, context + ".s")) ok = false;
    return ok;
}

bool validate(const unionCombat_Enchantment& rhs, const std::string& context)
{
    bool ok = true;
    if (!validate(rhs.s, context + ".s")) ok = false;
    return ok;
