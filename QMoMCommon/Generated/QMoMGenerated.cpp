...
QMoMTreeItemBase* constructTreeItem(Battle_Unit* rhs, const QString& context)
{
    ...
    ptree->appendChild("m_Building1Required_or_PortraitLbxIndex", new QMoMTreeItem<uint8_t>(&rhs->m_Building1Required_or_PortraitLbxIndex));
    ...
    ptree->appendChild("m_Max_figures", new QMoMTreeItem<uint8_t>(&rhs->m_Max_figures));
    ...
    ptree->appendChild("m_web_strength", new QMoMTreeItem<uint8_t>(&rhs->m_web_strength));
    ptree->appendChild("m_Active", new QMoMTreeItem<eBattleUnitActive>(&rhs->m_Active));
    ptree->appendChild("m_Owner", new QMoMTreeItem<ePlayer>(&rhs->m_Owner));
    ptree->appendChild("m_tracks_regular_damage", new QMoMTreeItem<int8_t>(&rhs->m_tracks_regular_damage));
    ptree->appendChild("m_tracks_lifesteal_damage", new QMoMTreeItem<int8_t>(&rhs->m_tracks_lifesteal_damage));
    ptree->appendChild("m_tracks_instant_damage_like_stoning", new QMoMTreeItem<int8_t>(&rhs->m_tracks_instant_damage_like_stoning));
    ptree->appendChild("m_top_figure_damage", new QMoMTreeItem<int8_t>(&rhs->m_top_figure_damage));
    ...
    ptree->appendChild("m_Current_mana", new QMoMTreeItem<int8_t>(&rhs->m_Current_mana));
    ptree->appendChild("m_Item_nr_charges", new QMoMTreeItem<int8_t>(&rhs->m_Item_nr_charges));
    ptree->appendChild("m_Poison_strength", new QMoMTreeItem<int8_t>(&rhs->m_Poison_strength));
...
QMoMTreeItemBase* constructTreeItem(Building_Data* rhs, const QString& context)
{
    ...
    ptree->appendChild("m_AI_trade_goods_housing", new QMoMTreeItem<uint16_t>(&rhs->m_AI_trade_goods_housing));
    ptree->appendChild("m_Zero_24", new QMoMTreeItem<uint16_t>(&rhs->m_Zero_24));
    ptree->appendChild("m_Zero_26", new QMoMTreeItem<uint16_t>(&rhs->m_Zero_26));
    ptree->appendChild("m_AI_Religious", new QMoMTreeItem<uint16_t>(&rhs->m_AI_Religious));
...
QMoMTreeItemBase* constructTreeItem(Events_Status* rhs, const QString& context)
{
    ...
    ptree->appendChild("m_Conjunction_Sorcery_Nr_GUESS", new QMoMTreeItem<uint16_t>(&rhs->m_Conjunction_Sorcery_Nr_GUESS));
    ptree->appendChild("m_Conjunction_Nature_active", new QMoMTreeItem<uint16_t>(&rhs->m_Conjunction_Nature_active));
    ptree->appendChild("m_Conjunction_Nature_Nr_GUESS", new QMoMTreeItem<uint16_t>(&rhs->m_Conjunction_Nature_Nr_GUESS));
    ptree->appendChild("m_Conjunction_Chaos_active", new QMoMTreeItem<uint16_t>(&rhs->m_Conjunction_Chaos_active));
    ptree->appendChild("m_Conjunction_Chaos_Nr_GUESS", new QMoMTreeItem<uint16_t>(&rhs->m_Conjunction_Chaos_Nr_GUESS));
...
QMoMTreeItemBase* constructTreeItem(MoMDataSegment* rhs, const QString& context)
{
    ...
    ptree->appendChild("m_Offset_UnitView_Lines", new QMoMTreeItem<uint16_t>(&rhs->m_Offset_UnitView_Lines));
...
QMoMTreeItemBase* constructTreeItem(UnitView_Lines* rhs, const QString& context)
{
    ...
    QMoMTreeItemBase* ptreem_bitmask_unitenchantment = ptree;
    if (40 > 3)
    {
        ptreem_bitmask_unitenchantment = new QMoMTreeItemBase("m_bitmask_unitenchantment");
    ...
    for (unsigned i = 0; i < 40; ++i)
    {
          ...
          ptreem_bitmask_unitenchantment->appendChild(oss.str().c_str(), new QMoMTreeItem<uint32_t>(&rhs->m_bitmask_unitenchantment[i]));
    }
    QMoMTreeItemBase* ptreem_icon_pic = ptree;
    if (40 > 3)
    {
        ptreem_icon_pic = new QMoMTreeItemBase("m_icon_pic");
    ...
    for (unsigned i = 0; i < 40; ++i)
    {
          std::ostringstream oss;
          oss << "m_icon_pic[" << i << "]";
          ptreem_icon_pic->appendChild(oss.str().c_str(), new QMoMTreeItem<uint16_t>(&rhs->m_icon_pic[i]));
    }
    QMoMTreeItemBase* ptreem_helpIndex = ptree;
    if (40 > 3)
    {
        ptreem_helpIndex = new QMoMTreeItemBase("m_helpIndex");
    ...
    for (unsigned i = 0; i < 40; ++i)
    {
          std::ostringstream oss;
          oss << "m_helpIndex[" << i << "]";
          ptreem_helpIndex->appendChild(oss.str().c_str(), new QMoMTreeItem<uint16_t>(&rhs->m_helpIndex[i]));
    }
    return ptree;
}
...
QMoMTreeItemBase* constructTreeItem(Unit_Type_Data* rhs, const QString& context)
{
    ...
    ptree->appendChild("m_Race_Code", new QMoMTreeItem<eRace>(&rhs->m_Race_Code));
    ptree->appendChild("m_Building1Required_or_PortraitLbxIndex", new QMoMTreeItem<uint8_t>(&rhs->m_Building1Required_or_PortraitLbxIndex));
    ptree->appendChild("m_Building2_or_HeroType", new QMoMTreeItem<eHero_TypeCode>(&rhs->m_Building2_or_HeroType));
    ptree->appendChild("m_Unit_picture", new QMoMTreeItem<uint16_t>(&rhs->m_Unit_picture));
    ...
    ptree->appendTree(constructTreeItem(&rhs->m_Ability_Flags, "m_Ability_Flags"), "");
    ptree->appendTree(constructTreeItem(&rhs->m_Attack_Flags, "m_Attack_Flags"), "");
    ptree->appendChild("m_Sound", new QMoMTreeItem<uint8_t>(&rhs->m_Sound));
...
QMoMTreeItemBase* constructTreeItem(Wizard* rhs, const QString& context)
{
    ...
    ptree->appendChild("m_ResearchCost_SpellofMastery_GUESS", new QMoMTreeItem<uint16_t>(&rhs->m_ResearchCost_SpellofMastery_GUESS));
    ...
    ptree->appendChild("m_Garrison_average_strength", new QMoMTreeItem<uint16_t>(&rhs->m_Garrison_average_strength));
    ...
    ptree->appendChild("m_Bitmask_banished_wizards", new QMoMTreeItem<uint16_t>(&rhs->m_Bitmask_banished_wizards));
