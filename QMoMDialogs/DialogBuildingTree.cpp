...
void DialogBuildingTree::addCitySubtree(QTreeWidget *treeWidget, MoMTerrain &momTerrain)
{
...
void DialogBuildingTree::addLairSubtree(QTreeWidget *treeWidget, MoMTerrain &momTerrain)
{
...
void DialogBuildingTree::addTerrainSubtree(QTreeWidget* treeWidget, MoMTerrain& momTerrain)
{
...
void DialogBuildingTree::addUnitSubtree(QTreeWidgetItem *treeWidgetItem, Unit* unit)
{
    assert(0 != unit);
...
void DialogBuildingTree::updateGraying()
{
